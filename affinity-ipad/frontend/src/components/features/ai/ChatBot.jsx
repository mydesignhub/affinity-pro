...
const FOLLOW_UP_MAP = {
    ...
    'Affinity Command Controller 🎛️': 'មុខងារ Quick Menu លើ iPad', 'affinity command controller ipad': 'ipad quick menu trick',
    'មុខងារ Quick Menu លើ iPad': 'ការភ្ជាប់ Keyboard លើ iPad ⌨️', 'ipad quick menu trick': 'ipad external keyboard support',
    'ការភ្ជាប់ Keyboard លើ iPad ⌨️': 'Shortcut ផ្លូវកាត់សំខាន់ៗមានអ្វីខ្លះ?', 'ipad external keyboard support': 'essential keyboard shortcuts affinity',
    ...
    'មុខងារ Apple Pencil និង Hover ✏️': 'Affinity Command Controller 🎛️', 'apple pencil pro hover ipad': 'affinity command controller ipad',
    'របៀបរៀបចំ Studio Panels លើ iPad': 'Affinity Command Controller 🎛️', 'managing ipad studio panels': 'affinity command controller ipad',
    'របៀបរើសវត្ថុច្រើនលើ iPad 👆': 'Snapping ក្នុង Affinity', 'multi select objects on ipad': 'snapping tool affinity',
    'របៀប Zoom និងរំកិលប្លង់លើ iPad 🔍': 'Affinity Command Controller 🎛️', 'ipad zoom and pan canvas': 'affinity command controller ipad',
    'របៀបបូមពណ៌លើ iPad 💧': 'Global Colors (ប្តូរពណ៌ម្តងទាំងអស់)', 'how to use color picker eyedropper ipad': 'affinity global colors swatches',
    'របៀប Save និង Cloud Sync លើ iPad ☁️': 'ការកាត់រូប Export (Slices)', 'saving and icloud sync affinity ipad': 'export persona slices',
    ...
    'Pen Tool និង Pencil Tool ខុសគ្នាម៉េច?': 'របៀបប្រើ Node Tool លើ iPad', 'pen tool vs pencil tool affinity': 'node tool vector editing',
    'របៀបប្រើ Node Tool លើ iPad': 'Geometry Operations (Add, Subtract, Intersect)', 'node tool vector editing': 'affinity boolean geometry pathfinder',
    ...
    'របៀបដាក់ Layer Effects (FX) ✨': 'Copy Effect ពី Layer មួយទៅមួយទៀត', 'layer effects fx panel ipad': 'paste fx layer styles affinity',
    'របៀបគូរទម្រង់ 3D (Isometric Grid)': 'Pen Tool និង Pencil Tool ខុសគ្នាម៉េច?', 'isometric grid affinity ipad': 'pen tool vs pencil tool affinity',
