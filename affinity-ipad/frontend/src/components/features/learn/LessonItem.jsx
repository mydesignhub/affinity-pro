...
import { ChevronDown, ChevronRight, Palette, Lightbulb, Layout, Globe, Search, Star, Sparkles, Play, MonitorPlay } from 'lucide-react';
                ...
                <div className="mt-5 pt-5 border-t border-[#0277C5]/10 animate-fade-in-up cursor-default" onClick={(e) => e.stopPropagation()}>
                    ...
                    {item.advancedUI === 'graphic_elements' && (
                        <div className={`mb-6 p-4 rounded-2xl border shadow-inner ${isDarkMode ? 'bg-[#121212] border-[#2C2C2C]' : 'bg-[#F8F9FA] border-[#E5E7EB]'}`}>
                            <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                                <div className={`flex flex-col items-center justify-center p-3 rounded-xl border shadow-sm ${isDarkMode ? 'bg-[#1E1E1E] border-[#2C2C2C]' : 'bg-white border-[#E5E7EB]'}`}><svg className={`w-10 h-10 mb-2 ${isDarkMode ? 'text-[#41B6E6]' : 'text-[#0277C5]'}`} viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="6" strokeLinecap="round"><path d="M10,90 Q50,10 90,90"/></svg><span className={`text-[10px] font-bold uppercase tracking-wider ${isDarkMode ? 'text-[#F1F1F1]' : 'text-[#1A1A1A]'}`}>Line</span></div>
                                <div className={`flex flex-col items-center justify-center p-3 rounded-xl border shadow-sm ${isDarkMode ? 'bg-[#1E1E1E] border-[#2C2C2C]' : 'bg-white border-[#E5E7EB]'}`}><svg className="w-10 h-10 mb-2 text-[#3B82F6]" viewBox="0 0 100 100" fill="currentColor"><polygon points="50,15 85,85 15,85"/></svg><span className={`text-[10px] font-bold uppercase tracking-wider ${isDarkMode ? 'text-[#F1F1F1]' : 'text-[#1A1A1A]'}`}>Shape</span></div>
                                <div className={`flex flex-col items-center justify-center p-3 rounded-xl border shadow-sm ${isDarkMode ? 'bg-[#1E1E1E] border-[#2C2C2C]' : 'bg-white border-[#E5E7EB]'}`}><svg className="w-10 h-10 mb-2 text-[#10B981]" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="6" strokeLinejoin="round"><polygon points="50,15 85,35 85,75 50,95 15,75 15,35" /><polyline points="15,35 50,55 85,35" /><line x1="50" y1="55" x2="50" y2="95" /></svg><span className={`text-[10px] font-bold uppercase tracking-wider ${isDarkMode ? 'text-[#F1F1F1]' : 'text-[#1A1A1A]'}`}>Form</span></div>
                                <div className={`flex flex-col items-center justify-center p-3 rounded-xl border shadow-sm ${isDarkMode ? 'bg-[#1E1E1E] border-[#2C2C2C]' : 'bg-white border-[#E5E7EB]'}`}><div className="w-10 h-10 mb-2 rounded-full border-2 border-white shadow-md" style={{background: 'conic-gradient(red, yellow, lime, cyan, blue, magenta, red)'}}></div><span className={`text-[10px] font-bold uppercase tracking-wider ${isDarkMode ? 'text-[#F1F1F1]' : 'text-[#1A1A1A]'}`}>Color</span></div>
                                <div className={`flex flex-col items-center justify-center p-3 rounded-xl border shadow-sm ${isDarkMode ? 'bg-[#1E1E1E] border-[#2C2C2C]' : 'bg-white border-[#E5E7EB]'}`}><div className="w-10 h-10 mb-2 flex items-center justify-center border-2 border-dashed border-[#6B7280] rounded-lg"><div className={`w-3 h-3 rounded-full ${isDarkMode ? 'bg-[#41B6E6]' : 'bg-[#0277C5]'}`}></div></div><span className={`text-[10px] font-bold uppercase tracking-wider ${isDarkMode ? 'text-[#F1F1F1]' : 'text-[#1A1A1A]'}`}>Space</span></div>
                                <div className={`flex flex-col items-center justify-center p-3 rounded-xl border shadow-sm ${isDarkMode ? 'bg-[#1E1E1E] border-[#2C2C2C]' : 'bg-white border-[#E5E7EB]'}`}><svg className="w-10 h-10 mb-2 text-[#8B5CF6]" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="4"><path d="M10,20 Q30,40 50,20 T90,20 M10,50 Q30,70 50,50 T90,50 M10,80 Q30,100 50,80 T90,80"/></svg><span className={`text-[10px] font-bold uppercase tracking-wider ${isDarkMode ? 'text-[#F1F1F1]' : 'text-[#1A1A1A]'}`}>Texture</span></div>
                                <div className={`flex flex-col items-center justify-center p-3 rounded-xl border shadow-sm col-span-3 sm:col-span-2 ${isDarkMode ? 'bg-[#1E1E1E] border-[#2C2C2C]' : 'bg-white border-[#E5E7EB]'}`}><div className="w-full h-8 mb-2 rounded-md shadow-inner border border-white/10" style={{background: 'linear-gradient(to right, #ffffff, #000000)'}}></div><span className={`text-[10px] font-bold uppercase tracking-wider ${isDarkMode ? 'text-[#F1F1F1]' : 'text-[#1A1A1A]'}`}>Value (Light / Dark)</span></div>
                            </div>
                        </div>
                    )}
                    ...
                    {item.advancedUI === 'graphic_prof_process' && (
                        <div className={`mb-6 p-8 rounded-2xl border shadow-inner flex flex-wrap items-center justify-center gap-2 sm:gap-4 ${isDarkMode ? 'bg-[#121212] border-[#2C2C2C]' : 'bg-[#F8F9FA] border-[#E5E7EB]'}`}>
                            ...
                            <div className={`h-0.5 w-4 sm:w-8 border-t-2 border-dashed mb-5 ${isDarkMode ? 'border-[#6B7280]' : 'border-[#A0A0A0]'}`}></div>
                            <div className="flex flex-col items-center gap-2"><div className={`w-10 h-10 rounded-full border-2 flex items-center justify-center ${isDarkMode ? 'border-[#41B6E6] bg-[#1E1E1E]' : 'border-[#0277C5] bg-white'}`}><svg className={`w-4 h-4 ${isDarkMode ? 'text-[#41B6E6]' : 'text-[#0277C5]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg></div><span className={`text-[8px] sm:text-[10px] font-bold uppercase tracking-wider ${isDarkMode?'text-[#A0A0A0]':'text-[#6B7280]'}`}>Sketch</span></div>
                            <div className={`h-0.5 w-4 sm:w-8 border-t-2 border-dashed mb-5 ${isDarkMode ? 'border-[#6B7280]' : 'border-[#A0A0A0]'}`}></div>
