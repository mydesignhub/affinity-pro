...
export const SUGGESTED_QUESTIONS = [
    ...
    "មុខងារ Apple Pencil និង Hover ✏️",
    "របៀបបូមពណ៌លើ iPad 💧",
    "របៀប Save និង Cloud Sync លើ iPad ☁️",
...
export const SUGGESTED_QUESTIONS_EN = [
    ...
    "Apple Pencil Pro & Hover features ✏️",
    "How to use the Color Picker on iPad 💧",
    "Saving and iCloud Sync on iPad ☁️",
