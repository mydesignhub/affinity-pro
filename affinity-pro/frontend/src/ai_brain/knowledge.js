// ==========================================
// 🧠 MASTER KNOWLEDGE BASE (PURE DATABASE)
// ==========================================
// ⚠️ Note: Greetings, Fallbacks, and Suggested Questions are handled in greetings.js and config.js
...
// ------------------------------------------
    ...
    // ==========================================================================
    // 🆕 KNOWLEDGE EXPANSION PACK — filling Graphic Design skill gaps
    // (color · typography · hands-on software · retouching · print · UI systems ·
    //  design history · process · AI). Same bilingual format as above.
    // ==========================================================================

    // ───────────── COLOR ─────────────
    {
        primaryKeys: ['តើ Tint, Shade និង Tone ខុសគ្នាម៉េច? 🎨', 'Tints, Shades, and Tones? 🎨'],
        keys: ['tint', 'shade', 'tone', 'tints', 'shades', 'tones', 'tint shade tone', 'ពណ៌ស្រាល', 'ពណ៌ចាស់', 'បន្ថែមពណ៌ស', 'បន្ថែមពណ៌ខ្មៅ'],
        regex: ['^tints?$', '^shades?$', '^tones?$', 'tint.*shade', 'shade.*tone'],
        answer: `🎨 **Tint, Shade, និង Tone** គឺជារបៀប ៣ យ៉ាងក្នុងការកែប្រែ Hue (ពណ៌ដើម) មួយ៖\n\n- **Tint (ពណ៌ស្រាល):** Hue + **ពណ៌ស** → ស្រាល, ស្រស់, ស្រាលភ្នែក (ឧ. ក្រហម → ផ្កាឈូក)។\n- **Shade (ពណ៌ចាស់):** Hue + **ពណ៌ខ្មៅ** → ជ្រៅ, ខ្លាំង, Luxury (ឧ. ក្រហម → ឈាមជ្រូក)។\n- **Tone (ពណ៌ស្ងប់):** Hue + **ពណ៌ប្រផេះ** → ស្ងប់, ទន់, Professional។\n\n💡 **គន្លឹះអ្នកជំនាញ:** កុំប្រើ Hue សុទ្ធ ១០០% ច្រើនពេក — វាធ្វើឱ្យភ្នែកអស់កម្លាំង។ Designer ស្ទាត់ប្រើ Tint/Shade/Tone ដើម្បីបង្កើត Palette ដែលមើលទៅ "ថ្លៃ" និងមានជម្រៅ។`,
        answer_en: `🎨 **Tints, Shades, and Tones** are the three ways to modify a single Hue (base color):\n\n- **Tint:** Hue + **white** → lighter, softer, airier (e.g. red → pink).\n- **Shade:** Hue + **black** → deeper, richer, more luxurious (e.g. red → maroon).\n- **Tone:** Hue + **gray** → muted, calmer, more professional.\n\n💡 **Pro Tip:** Never overuse a 100% pure hue — it fatigues the eye. Pros build palettes from tints/shades/tones to get a "premium", layered look with depth.`,
        chips: ['តើ Color Theory ជាអ្វី? 🎨', 'តើ HSL គឺជាអ្វី? 🎛️', 'តើច្បាប់ពណ៌ ៦០-៣០-១០ ជាអ្វី? 🎨'],
        chips_en: ['Can you explain Color Theory? 🎨', 'What is HSL? 🎛️', 'What is the 60-30-10 Rule? 🎨']
    },
    {
        primaryKeys: ['តើ Complementary, Analogous, Triadic Colors ខុសគ្នាម៉េច? 🎨', 'Complementary vs Analogous vs Triadic Colors? 🎨'],
        keys: ['complementary', 'analogous', 'triadic', 'tetradic', 'split complementary', 'monochromatic', 'color harmony', 'color scheme', 'color wheel', 'ក្បួនលាយពណ៌', 'រង្វង់ពណ៌', 'ពណ៌ផ្ទុយ'],
        regex: ['^complementary$', '^analogous$', '^triadic$', '^monochromatic$', 'color\\s*(harmony|scheme)', 'color\\s*wheel'],
        answer: `🎨 **Color Schemes** គឺជារូបមន្តលើ **Color Wheel** សម្រាប់រើសពណ៌ឱ្យចុះសម្រុងគ្នា៖\n\n- **Monochromatic:** Hue តែ ១ + Tint/Shade ផ្សេងៗ → ស្អាត, ងាយ, ស្ងប់។\n- **Analogous:** ៣ ពណ៌ជាប់គ្នាលើរង្វង់ (ឧ. ខៀវ–បៃតង–លឿងបៃតង) → ធម្មជាតិ, ស្រួលភ្នែក។\n- **Complementary:** ២ ពណ៌ផ្ទុយគ្នា ១៨០° (ឧ. ខៀវ↔ទឹកក្រូច) → Contrast ខ្លាំង, ទាក់ភ្នែក។\n- **Split-Complementary:** ១ ពណ៌ + ២ ពណ៌ក្បែរពណ៌ផ្ទុយ → Contrast តែទន់ជាង។\n- **Triadic:** ៣ ពណ៌ចម្ងាយស្មើ ១២០° → រស់រវើក, លំនឹង។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ប្រើ **Adobe Color** ឬ **Coolors.co** ដើម្បីសាក Scheme ទាំងនេះ។ ច្បាប់មាស៖ ប្រើ ១ Scheme ក្នុង ១ Design — កុំលាយច្រើនពេក!`,
        answer_en: `🎨 **Color Schemes** are formulas on the **Color Wheel** for picking colors that work together:\n\n- **Monochromatic:** one hue + its tints/shades → clean, easy, calm.\n- **Analogous:** 3 neighbors on the wheel (e.g. blue–green–yellow-green) → natural, easy on the eyes.\n- **Complementary:** 2 opposite hues 180° apart (e.g. blue↔orange) → high contrast, eye-grabbing.\n- **Split-Complementary:** 1 color + the 2 beside its opposite → strong but softer contrast.\n- **Triadic:** 3 hues evenly spaced 120° apart → vibrant and balanced.\n\n💡 **Pro Tip:** Test these in **Adobe Color** or **Coolors.co**. Golden rule: use ONE scheme per design — don't mix several!`,
        chips: ['តើ Color Theory ជាអ្វី? 🎨', 'តើ Tint, Shade និង Tone ខុសគ្នាម៉េច? 🎨', 'របៀបបង្កើត Brand Color Palette? 🎨'],
        chips_en: ['Can you explain Color Theory? 🎨', 'Tints, Shades, and Tones? 🎨', 'How to build a brand color palette? 🎨']
    },
    {
        primaryKeys: ['តើ Warm Colors និង Cool Colors ខុសគ្នាម៉េច? 🌡️', 'Warm vs Cool Colors (Color Temperature)? 🌡️'],
        keys: ['warm color', 'cool color', 'warm colors', 'cool colors', 'color temperature', 'temperature', 'ពណ៌ក្ដៅ', 'ពណ៌ត្រជាក់', 'សីតុណ្ហភាពពណ៌'],
        regex: ['warm\\s*colors?', 'cool\\s*colors?', 'color\\s*temperature', 'ពណ៌(ក្ដៅ|ត្រជាក់)'],
        answer: `🌡️ **Color Temperature** បែងចែកពណ៌ជា ២ ក្រុមតាមអារម្មណ៍៖\n\n🔥 **Warm Colors (ក្ដៅ):** ក្រហម, ទឹកក្រូច, លឿង → ថាមពល, រំភើប, ស្និទ្ធស្នាល, ឃ្លាន។ ពួកវាមើលទៅ "ខិតមកជិត" (Advance)។\n❄️ **Cool Colors (ត្រជាក់):** ខៀវ, បៃតង, ស្វាយ → ស្ងប់, ទុកចិត្ត, ស្អាត, Professional។ ពួកវាមើលទៅ "ថយក្រោយ" (Recede)។\n\n🎯 **ការប្រើ:** Restaurant ប្រើ Warm ដើម្បីបង្កើនចំណង់អាហារ; Bank/Tech ប្រើ Cool ដើម្បីបង្ហាញទំនុកចិត្ត។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ដាក់វត្ថុ Warm លើ Background ត្រជាក់ → វានឹង"លោត" ចេញមកមុខភ្លាម (បច្ចេកទេសបង្កើត Focal Point)។`,
        answer_en: `🌡️ **Color Temperature** splits colors into two emotional groups:\n\n🔥 **Warm Colors:** red, orange, yellow → energy, excitement, appetite, intimacy. They appear to "advance" toward the viewer.\n❄️ **Cool Colors:** blue, green, purple → calm, trust, clean, professional. They appear to "recede" into the background.\n\n🎯 **Usage:** Restaurants use warm tones to boost appetite; banks/tech brands use cool tones to signal trust.\n\n💡 **Pro Tip:** Place a warm subject on a cool background and it instantly "pops" forward — a classic trick for creating a Focal Point.`,
        chips: ['តើ Focal Point ជាអ្វី? 🎯', 'តើអត្ថន័យនៃពណ៌នីមួយៗតំណាងឱ្យអ្វី? 🧠', 'តើ Contrast ជាអ្វី? 🌗'],
        chips_en: ['What is a Focal Point? 🎯', 'What is Color Psychology? 🧠', 'What is Contrast? 🌗']
    },
    {
        primaryKeys: ['តើ Hex Code (#FFFFFF) អានយ៉ាងម៉េច? #️⃣', 'How do Hex Color Codes work? #️⃣'],
        keys: ['hex', 'hex code', 'hex color', 'hexadecimal', 'color code', '#ffffff', 'កូដពណ៌', 'hex ពណ៌'],
        regex: ['^hex$', 'hex\\s*(code|color|colour)', 'hexadecimal', 'color\\s*code'],
        answer: `#️⃣ **Hex Code** គឺជារបៀបសរសេរពណ៌សម្រាប់អេក្រង់ ដោយប្រើលេខ ៦ ខ្ទង់ក្រោយសញ្ញា **#**។\n\nវាគឺ **RGB** ក្នុងទម្រង់ Hexadecimal៖ \`#RRGGBB\`\n- **RR** = ក្រហម, **GG** = បៃតង, **BB** = ខៀវ។\n- តម្លៃនីមួយៗ ពី \`00\` (គ្មាន) ដល់ \`FF\` (ពេញ ២៥៥)។\n\n**ឧទាហរណ៍:**\n- \`#FFFFFF\` = ស (RGB ពេញទាំង ៣)។\n- \`#000000\` = ខ្មៅ (សូន្យទាំង ៣)។\n- \`#FF0000\` = ក្រហមសុទ្ធ។\n- \`#0277C5\` = ខៀវ។\n\n💡 **គន្លឹះអ្នកជំនាញ:** Hex ៣ ខ្ទង់ (\`#FFF\`) គឺ Shorthand នៃ \`#FFFFFF\`។ ប្រើ **Eyedropper Tool** ដើម្បីចម្លង Hex ពីរូបណាមួយ — រួចបិទភ្ជាប់ចូល Coolors ដើម្បីបង្កើត Palette ពេញ!`,
        answer_en: `#️⃣ **Hex codes** are how screens describe color — a 6-digit value after a **#**.\n\nIt's just **RGB** written in hexadecimal: \`#RRGGBB\`\n- **RR** = red, **GG** = green, **BB** = blue.\n- Each pair runs from \`00\` (none) to \`FF\` (full 255).\n\n**Examples:**\n- \`#FFFFFF\` = white (all RGB full).\n- \`#000000\` = black (all zero).\n- \`#FF0000\` = pure red.\n- \`#0277C5\` = a blue.\n\n💡 **Pro Tip:** A 3-digit hex (\`#FFF\`) is shorthand for \`#FFFFFF\`. Use the **Eyedropper Tool** to copy any hex from an image, then paste it into Coolors to build a full palette!`,
        chips: ['តើ RGB និង CMYK ខុសគ្នាម៉េច? 🖨️', 'តើ HSL គឺជាអ្វី? 🎛️', 'របៀបបង្កើត Brand Color Palette? 🎨'],
        chips_en: ['RGB vs CMYK? 🖨️', 'What is HSL? 🎛️', 'How to build a brand color palette? 🎨']
    },
    {
        primaryKeys: ['តើ Duotone Effect ជាអ្វី? 🟣', 'What is the Duotone Effect? 🟣'],
        keys: ['duotone', 'duo tone', 'two tone', 'spotify effect', 'tritone', 'ពណ៌ពីរ'],
        regex: ['^duotone$', 'duo\\s*tone', 'two\\s*tone', 'tritone'],
        answer: `🟣 **Duotone** គឺ Effect ដែលប្ដូររូបថត (Grayscale) ឱ្យប្រើពណ៌តែ **២** ប៉ុណ្ណោះ — ១ សម្រាប់ Shadow (ស្រមោល) និង ១ សម្រាប់ Highlight (ពន្លឺ)។\n\nវាល្បីខ្លាំងពី **Spotify** (ផ្កាឈូក + ខៀវ)។ វាបង្កើតរូបភាពដែលមើលទៅ "ម៉ូដ", ឯកភាព, និងជាប់ Brand។\n\n🛠️ **របៀបធ្វើ (Photoshop):**\n១. ប្ដូររូបជា Black & White។\n២. Image → Mode → Duotone, ឬប្រើ **Gradient Map** (ងាយជាង)។\n③. ជ្រើស ២ Brand Colors របស់បង។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ប្រើ Duotone ដោយយក ២ ពណ៌ Brand ដើម្បីឱ្យ Photo ទាំងអស់របស់ Campaign មើលទៅជាប់គ្នា (Consistent) ដោយមិនបាច់ថតរូបឡើងវិញ។`,
        answer_en: `🟣 **Duotone** maps a grayscale photo onto just **two** colors — one for the shadows, one for the highlights.\n\nFamously used by **Spotify** (pink + blue). It produces a trendy, unified, on-brand image style.\n\n🛠️ **How (Photoshop):**\n1. Convert the photo to black & white.\n2. Image → Mode → Duotone, or use a **Gradient Map** (easier).\n3. Pick your two brand colors.\n\n💡 **Pro Tip:** Apply a duotone with your two brand colors to make every photo across a campaign look consistent — without reshooting anything.`,
        chips: ['តើ Blending Modes គឺជាអ្វី? 🎞️', 'របៀបបង្កើត Brand Color Palette? 🎨', 'តើ Gradients និង Solid Colors ប្រើខុសគ្នាម៉េច? 🌈'],
        chips_en: ['What are Blending Modes? 🎞️', 'How to build a brand color palette? 🎨', 'Gradients vs Solid Colors? 🌈']
    },

    // ───────────── TYPOGRAPHY ─────────────
    {
        primaryKeys: ['ប្រភេទ Font (Type Classification) មានអ្វីខ្លះ? 🔠', 'Font Classification (Serif, Slab, Script)? 🔠'],
        keys: ['type classification', 'font classification', 'font types', 'old style', 'transitional', 'slab serif', 'script font', 'display font', 'monospace', 'ប្រភេទ font', 'ប្រភេទអក្សរ'],
        regex: ['type\\s*classification', 'font\\s*(classification|types?|categor)', 'slab\\s*serif', '^monospace$', 'script\\s*font'],
        answer: `🔠 **ប្រភេទ Font ធំៗ** ដែល Designer ត្រូវស្គាល់៖\n\n- **Serif** (មានកន្ទុយ): ផ្លូវការ, គួរឱ្យទុកចិត្ត (Times, Garamond)។\n- **Sans-Serif** (គ្មានកន្ទុយ): ទំនើប, ស្រឡះ, ល្អ UI (Helvetica, Inter)។\n- **Slab Serif** (កន្ទុយក្រាស់ការ៉េ): រឹងមាំ, ក្លាហាន (Rockwell, Roboto Slab)។\n- **Script** (សរសេរដៃ): ស្រស់ស្អាត, Wedding, Luxury (Pacifico)។\n- **Display / Decorative**: សម្រាប់ចំណងជើងធំៗ ប៉ុណ្ណោះ កុំប្រើជា Body!\n- **Monospace** (អក្សរទទឹងស្មើ): Code, Tech (Courier, JetBrains Mono)។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ផ្គូផ្គង **Serif + Sans-Serif** គឺជាគូដ៏សុវត្ថិភាពបំផុត។ កុំប្រើ Font ច្រើនជាង ២–៣ ក្នុង ១ Project!`,
        answer_en: `🔠 **The major font categories** every designer should know:\n\n- **Serif** (with feet): formal, trustworthy (Times, Garamond).\n- **Sans-Serif** (no feet): modern, clean, great for UI (Helvetica, Inter).\n- **Slab Serif** (thick blocky feet): bold, sturdy (Rockwell, Roboto Slab).\n- **Script** (handwritten): elegant — weddings, luxury (Pacifico).\n- **Display / Decorative:** headlines ONLY — never body text!\n- **Monospace** (equal-width): code, tech (Courier, JetBrains Mono).\n\n💡 **Pro Tip:** Pairing a **Serif + a Sans-Serif** is the safest combo. Never use more than 2–3 fonts in a single project!`,
        chips: ['របៀបតម្រៀប Font ឱ្យស្អាត? 🅰️', 'តើ Serif និង Sans-Serif ខុសគ្នាម៉េច? 🖋️', 'តើ Typography Anatomy ជាអ្វី? 🔤'],
        chips_en: ['How to properly pair fonts? 🅰️', 'Serif vs Sans-Serif? 🖋️', 'Explain Typography Anatomy 🔤']
    },
    {
        primaryKeys: ['រក Font ល្អៗ និងស្របច្បាប់ (Font Licensing) ពីណា? ⚖️', 'Where to get fonts & font licensing? ⚖️'],
        keys: ['font license', 'font licensing', 'where to get fonts', 'free fonts', 'google fonts', 'commercial font', 'font copyright', 'រក font', 'font ឥតគិតថ្លៃ', 'license font'],
        regex: ['font\\s*licens', 'free\\s*fonts?', 'google\\s*fonts?', 'where.*fonts?', 'font\\s*copyright', 'commercial.*font'],
        answer: `⚖️ **Font ក៏មានកម្មសិទ្ធិបញ្ញាដែរ!** ការទាញ Font ពីគេහើយប្រើពាណិជ្ជកម្ម អាចត្រូវប្ដឹង។\n\n✅ **ប្រភពស្របច្បាប់ (ច្រើនឥតគិតថ្លៃ):**\n- **Google Fonts** — ឥតគិតថ្លៃ ១០០%, ប្រើពាណិជ្ជកម្មបាន (Inter, Roboto, Poppins)។\n- **Fontshare, Fontsquirrel** — ឥតគិតថ្លៃសម្រាប់ Commercial។\n- **Adobe Fonts** — រួមក្នុង Creative Cloud Subscription។\n- **MyFonts, Fontspring** — ទិញ License។\n\n📜 **ប្រភេទ License ត្រូវចេះ:**\n- **Desktop:** សម្រាប់ Print/Logo។\n- **Webfont:** សម្រាប់ Website។\n- **App/Embed:** សម្រាប់ App/PDF។\n\n💡 **គន្លឹះអ្នកជំនាញ:** សម្រាប់ Logo អតិថិជន — ប្រើ Font ដែលមាន License ច្បាស់លាស់, ឬ Convert ទៅ **Outline (Vector)** ដើម្បីកុំឱ្យមានបញ្ហាច្បាប់ពេលក្រោយ។`,
        answer_en: `⚖️ **Fonts are copyrighted too!** Downloading a random font and using it commercially can get you sued.\n\n✅ **Legal sources (many free):**\n- **Google Fonts** — 100% free, commercial-safe (Inter, Roboto, Poppins).\n- **Fontshare, Font Squirrel** — free for commercial use.\n- **Adobe Fonts** — included with Creative Cloud.\n- **MyFonts, Fontspring** — purchase licenses.\n\n📜 **License types to know:**\n- **Desktop:** for print/logos.\n- **Webfont:** for websites.\n- **App/Embed:** for apps/PDFs.\n\n💡 **Pro Tip:** For a client logo, use a clearly-licensed font, or convert the text to **Outlines (vector)** so there's never a licensing problem later.`,
        chips: ['របៀបរើស Font ឱ្យត្រូវនឹងម៉ាកយីហោ? 🅰️', 'ក្រមសីលធម៌ និងកម្មសិទ្ធិបញ្ញា ⚖️', 'តើ Font ខ្មែរល្អបំផុតមានអ្វីខ្លះ? 🇰🇭'],
        chips_en: ['How to choose the right font? 🅰️', 'Design Ethics & Copyright ⚖️', 'Best Khmer Fonts for design? 🇰🇭']
    },
    {
        primaryKeys: ['តើ TTF, OTF, និង WOFF ខុសគ្នាម៉េច? 🔤', 'TTF vs OTF vs WOFF font formats? 🔤'],
        keys: ['ttf', 'otf', 'woff', 'woff2', 'font format', 'font file', 'opentype', 'truetype', 'ប្រភេទ file font'],
        regex: ['^ttf$', '^otf$', '^woff2?$', 'font\\s*format', 'truetype', 'opentype\\s*file'],
        answer: `🔤 **Font File Formats** ៣ ប្រភេទសំខាន់៖\n\n- **TTF (TrueType):** ចាស់, ប្រើបានគ្រប់ OS, ស្ថេរភាព។ ល្អសម្រាប់ Office/Print ទូទៅ។\n- **OTF (OpenType):** ទំនើបជាង, មាន Feature ច្រើន (Ligatures, Alternates, Small Caps)។ Designer គួរប្រើ OTF។\n- **WOFF / WOFF2:** Font សម្រាប់ **Website** ដោយ Compress តូច → Load លឿន។ WOFF2 តូចជាង WOFF ៣០%។\n\n💡 **គន្លឹះអ្នកជំនាញ:** សម្រាប់ Branding/Print ប្រើ **OTF** (មាន OpenType Features ស្អាត); សម្រាប់ Web ប្រើ **WOFF2**។ កុំ Upload TTF ធំៗទៅ Website — វាធ្វើឱ្យ Page យឺត!`,
        answer_en: `🔤 **Font file formats** — the 3 that matter:\n\n- **TTF (TrueType):** older, works on every OS, rock-solid. Fine for general office/print.\n- **OTF (OpenType):** more modern, richer features (ligatures, alternates, small caps). Designers should prefer OTF.\n- **WOFF / WOFF2:** **web** fonts, compressed small for fast loading. WOFF2 is ~30% smaller than WOFF.\n\n💡 **Pro Tip:** Use **OTF** for branding/print (nice OpenType features) and **WOFF2** for the web. Never load big TTF files on a website — it slows the page down!`,
        chips: ['តើ Variable Font ជាអ្វី? 🔠', 'តើ លក្ខណៈពិសេស OpenType (Ligatures) ជាអ្វី? 🔠', 'របៀប Export រូបបង្ហោះកុំឱ្យបែកគុណភាព? 📱'],
        chips_en: ['What is a Variable Font? 🔠', 'What are OpenType Features (Ligatures)? 🔠', 'How to export high-quality for social media? 📱']
    },

    // ───────────── LAYOUT & COMPOSITION ─────────────
    {
        primaryKeys: ['តើ Symmetry និង Asymmetry ខុសគ្នាម៉េច? ⚖️', 'Symmetry vs Asymmetry in design? ⚖️'],
        keys: ['symmetry', 'asymmetry', 'symmetrical', 'asymmetrical', 'radial balance', 'balance type', 'តុល្យភាពស៊ីមេទ្រី', 'លំនឹង'],
        regex: ['^symmetry$', '^asymmetry$', 'symmetric', 'asymmetric', 'radial\\s*balance'],
        answer: `⚖️ **Balance** មាន ៣ ប្រភេទ៖\n\n- **Symmetrical (ស៊ីមេទ្រី):** ឆ្វេង = ស្ដាំ ដូចគ្នា (Mirror)។ → ផ្លូវការ, ស្ងប់, ទុកចិត្ត (ឧ. ឡូហ្គោ Bank, Wedding Invitation)។ ងាយធ្វើ តែអាចមើលទៅ "ស្ងួត"។\n- **Asymmetrical (មិនស៊ីមេទ្រី):** ឆ្វេង ≠ ស្ដាំ តែនៅតែមាន **Visual Weight** លំនឹង (ឧ. វត្ថុធំ ១ តុល្យនឹងវត្ថុតូច ៣)។ → ថាមវន្ត, ទំនើប, គួរឱ្យចាប់អារម្មណ៍។ ពិបាកជាង តែ Pro ជាង។\n- **Radial (កាំ):** វត្ថុរាយចេញពីចំណុចកណ្ដាល (ឧ. ព្រះអាទិត្យ)។\n\n💡 **គន្លឹះអ្នកជំនាញ:** Asymmetry + White Space = រូបរាង Editorial/Magazine ដ៏ទាន់សម័យ។ ប្រើ Visual Weight (ទំហំ, ពណ៌, Contrast) ដើម្បីបង្កើតលំនឹង មិនមែនទីតាំង។`,
        answer_en: `⚖️ **Balance** comes in three types:\n\n- **Symmetrical:** left = right, mirrored. → formal, calm, trustworthy (bank logos, wedding invites). Easy, but can feel "stiff".\n- **Asymmetrical:** left ≠ right, yet still balanced by **visual weight** (one big object balances three small ones). → dynamic, modern, interesting. Harder, but more pro.\n- **Radial:** elements radiate from a center point (like a sun).\n\n💡 **Pro Tip:** Asymmetry + white space = the trendy editorial/magazine look. Balance with visual weight (size, color, contrast), not just position.`,
        chips: ['តើ Visual Weight ជាអ្វី? ⚖️', 'អ្វីទៅជា White Space? 🤍', 'តើ Balance និង Alignment ខុសគ្នាម៉េច? ⚖️'],
        chips_en: ['What is Visual Weight? ⚖️', 'What is White Space? 🤍', "Balance vs Alignment: What's the difference? ⚖️"]
    },
    {
        primaryKeys: ['តើ Golden Ratio (1.618) ប្រើយ៉ាងម៉េច? 🌀', 'How to use the Golden Ratio (1.618)? 🌀'],
        keys: ['golden ratio', 'golden section', 'fibonacci', 'phi', '1.618', 'divine proportion', 'golden spiral', 'សមាមាត្រមាស'],
        regex: ['golden\\s*(ratio|section|spiral)', '1\\.618', '\\bphi\\b', 'divine\\s*proportion'],
        answer: `🌀 **Golden Ratio (φ ≈ 1.618)** គឺជាសមាមាត្រដែលមនុស្សយល់ឃើញថា "ស្អាតធម្មជាតិ" — ឃើញនៅសំបកសត្វ, ផ្កា, និងមុខមនុស្ស។\n\n📐 **របៀបប្រើក្នុង Design:**\n- **Layout:** បែងចែកទំព័រ ៖ ផ្នែកធំ ៖ ផ្នែកតូច = 1.618 ៖ 1 (ដូច Rule of Thirds តែ Pro ជាង)។\n- **Typography:** Body 16px → Heading 16 × 1.618 ≈ 26px (Modular Scale)។\n- **Logo:** Twitter, Apple, Pepsi ប្រើ Golden Circles ត្រួតគ្នាដើម្បីគូរ Curve ស្អាត។\n\n💡 **គន្លឹះអ្នកជំនាញ:** កុំ Obsess ពេក! Golden Ratio ជា "ចំណុចចាប់ផ្ដើម" ល្អ មិនមែនច្បាប់រឹង។ ភ្នែករបស់បងសំខាន់ជាងលេខ — បើវាមើលទៅស្អាត នោះវាត្រូវ។`,
        answer_en: `🌀 **The Golden Ratio (φ ≈ 1.618)** is a proportion humans perceive as "naturally beautiful" — found in shells, flowers, and faces.\n\n📐 **How to use it in design:**\n- **Layout:** split a page so large ÷ small = 1.618 ÷ 1 (like the Rule of Thirds, but more refined).\n- **Typography:** body 16px → heading 16 × 1.618 ≈ 26px (a modular scale).\n- **Logos:** Twitter, Apple and Pepsi used overlapping golden circles to draw smooth curves.\n\n💡 **Pro Tip:** Don't obsess over it! The Golden Ratio is a great *starting point*, not a rigid law. Your eye matters more than the math — if it looks right, it is right.`,
        chips: ['តើ Rule of Thirds និង Golden Ratio ខុសគ្នាម៉េច? 📐', 'តើលំដាប់លេខ Fibonacci ទាក់ទងនឹងការរចនាយ៉ាងម៉េច? 🌀', 'តើ Grid System គឺជាអ្វី? 📐'],
        chips_en: ['Rule of Thirds vs Golden Ratio? 📐', 'Fibonacci Sequence in Design? 🌀', 'What is a Grid System? 📐']
    },
    {
        primaryKeys: ['តើ Rule of Thirds ប្រើយ៉ាងម៉េច? 📸', 'How to use the Rule of Thirds? 📸'],
        keys: ['rule of thirds', 'thirds', 'grid 3x3', 'composition rule', 'ច្បាប់បីភាគ', 'ច្បាប់បីផ្នែក'],
        regex: ['rule\\s*of\\s*thirds', '3\\s*x\\s*3\\s*grid', 'ច្បាប់.*បី(ភាគ|ផ្នែក)'],
        answer: `📸 **Rule of Thirds** ៖ បែងចែក Canvas ជា **៣×៣** (បន្ទាត់បញ្ឈរ ២ + ផ្ដេក ២) → បាន ៤ ចំណុចប្រសព្វ។\n\nដាក់ Subject សំខាន់ៗ **លើបន្ទាត់ ឬត្រង់ចំណុចប្រសព្វ** ជំនួសឱ្យកណ្ដាល → រូបភាពមើលទៅមានជីវិត, លំនឹង, និងធម្មជាតិជាង។\n\n🎯 **ការប្រើ:**\n- **Photography:** ដាក់ភ្នែកមនុស្សលើបន្ទាត់ខាងលើ; ផ្ដេកមេឃ/ដី ត្រង់បន្ទាត់។\n- **Poster/Layout:** ដាក់ Logo ឬ Headline ត្រង់ចំណុចប្រសព្វ។\n\n💡 **គន្លឹះអ្នកជំនាញ:** កាមេរ៉ាទូរស័ព្ទភាគច្រើនមាន Grid នេះស្រាប់ (បើកក្នុង Settings)។ ដាក់កណ្ដាល (Center) ល្អសម្រាប់ Symmetry; ដាក់ Thirds ល្អសម្រាប់ Storytelling។`,
        answer_en: `📸 **Rule of Thirds:** divide the canvas into a **3×3** grid (2 vertical + 2 horizontal lines) → 4 intersection points.\n\nPlace key subjects **on the lines or at the intersections** instead of dead-center → the image feels more alive, balanced, and natural.\n\n🎯 **Usage:**\n- **Photography:** put eyes on the top line; align horizon to a line.\n- **Poster/Layout:** place the logo or headline at an intersection.\n\n💡 **Pro Tip:** Most phone cameras have this grid built in (enable it in Settings). Center framing suits symmetry; thirds suit storytelling.`,
        chips: ['តើ Rule of Thirds និង Golden Ratio ខុសគ្នាម៉េច? 📐', 'តើ Focal Point ជាអ្វី? 🎯', 'តើ Framing (ការដាក់ស៊ុម) ប្រើសម្រាប់អ្វី? 🖼️'],
        chips_en: ['Rule of Thirds vs Golden Ratio? 📐', 'What is a Focal Point? 🎯', 'How to use Framing in design? 🖼️']
    },

    // ───────────── HANDS-ON SOFTWARE SKILLS ─────────────
    {
        primaryKeys: ['របៀបប្រើ Pen Tool និង Anchor Points ឱ្យស្ទាត់ 🖊️', 'How to master the Pen Tool & Anchor Points? 🖊️'],
        keys: ['pen tool', 'anchor point', 'anchor points', 'bezier handle', 'path', 'vector path', 'how to use pen tool', 'pen tool tutorial', 'ប្រើ pen tool', 'គូរ path'],
        regex: ['pen\\s*tool', 'anchor\\s*points?', 'bezier\\s*handle', 'vector\\s*path', 'គូរ.*path'],
        answer: `🖊️ **Pen Tool** គឺជាឧបករណ៍សំខាន់បំផុត និងពិបាកបំផុតក្នុង Illustrator/Photoshop — តែបើស្ទាត់ បងគូរអ្វីក៏បាន!\n\n📌 **គោលការណ៍សំខាន់ៗ:**\n- **Click** = បង្កើត Anchor Point ដែលមានជ្រុងស្រួច (Corner)។\n- **Click + Drag** = បង្កើត Anchor ដែលមាន **Handles** សម្រាប់គូរ Curve រលូន។\n- **Handle** កាន់តែវែង = Curve កាន់តែជ្រៅ។\n- ចុច **Alt/Option** លើ Handle ដើម្បីបំបែក Curve (ប្ដូរទិសម្ខាង)។\n\n🎯 **ច្បាប់មាស ៣ យ៉ាង:**\n១. ប្រើ Anchor Point **តិចតួចបំផុត** (កុំចុចច្រើនពេក)។\n២. ដាក់ Anchor ត្រង់កន្លែង Curve ប្ដូរទិស។\n③. ទាញ Handle ប្រហែល ⅓ នៃប្រវែង Curve។\n\n💡 **គន្លឹះអ្នកជំនាញ:** លេង **"The Bézier Game" (bezier.method.ac)** ឥតគិតថ្លៃ ៣០ នាទី/ថ្ងៃ — ក្នុង ១ សប្ដាហ៍ បងនឹងស្ទាត់ Pen Tool!`,
        answer_en: `🖊️ **The Pen Tool** is the most important — and most intimidating — tool in Illustrator/Photoshop. Master it and you can draw anything!\n\n📌 **Core principles:**\n- **Click** = a sharp corner anchor point.\n- **Click + Drag** = an anchor with **handles** that draw a smooth curve.\n- Longer handle = deeper curve.\n- Hold **Alt/Option** on a handle to break the curve (change one side's direction).\n\n🎯 **3 golden rules:**\n1. Use as **few** anchor points as possible.\n2. Place anchors where the curve *changes direction*.\n3. Drag handles to about ⅓ the length of the curve.\n\n💡 **Pro Tip:** Play the free **"Bézier Game" (bezier.method.ac)** 30 min/day — within a week you'll master the Pen Tool!`,
        chips: ['តើ Bézier Curve គឺជាអ្វី? 🖋️', 'តើ Vector និង Raster ខុសគ្នាម៉េច? 🖼️', 'របៀបបំប្លែងរូបភាពទៅជា Vector (Image Trace)? 🖼️'],
        chips_en: ['What is a Bézier Curve? 🖋️', "Vector vs Raster: What's the difference? 🖼️", 'How to convert raster to vector? 🖼️']
    },
    {
        primaryKeys: ['តើ Clipping Mask និង Layer Mask ខុសគ្នាម៉េច? 🎭', 'Clipping Mask vs Layer Mask? 🎭'],
        keys: ['clipping mask', 'layer mask', 'clipping vs layer mask', 'mask difference', 'masking', 'clip mask', 'mask ខុសគ្នា'],
        regex: ['clipping\\s*mask', 'clip\\s*mask', 'mask.*(vs|difference|ខុសគ្នា)'],
        answer: `🎭 ទាំងពីរ "លាក់" ផ្នែករូប តែធ្វើការខុសគ្នា៖\n\n✂️ **Clipping Mask:** ប្រើ **រូបរាង (Shape/Text)** មួយ ដើម្បីកាត់រូប/ពណ៌ឱ្យលេចតែខាងក្នុង Shape នោះ។\n- ឧ. ដាក់រូបថតចូលក្នុងអក្សរ "LOVE"។\n- រូបនៅខាងលើ → ចុច Alt រវាង ២ Layer (Photoshop), ឬ Object → Clipping Mask (Illustrator)។\n\n⚫⚪ **Layer Mask:** ប្រើ **Grayscale** (ស/ខ្មៅ) ដើម្បីបង្ហាញ/លាក់ផ្នែករូប **ដោយ Non-Destructive**។\n- **ស = បង្ហាញ, ខ្មៅ = លាក់, ប្រផេះ = ថ្លាៗ**។\n- ល្អបំផុតសម្រាប់លាយ ២ រូប (Blend) ឱ្យរលូន ដោយប្រើ Brush ខ្មៅលើ Mask។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ប្រើ **Clipping Mask** ដើម្បីដាក់រូបចូល Shape; ប្រើ **Layer Mask** ដើម្បីលុបផ្ទៃខាងក្រោយ ឬលាយ Gradient ដោយមិនបំផ្លាញរូបដើម។`,
        answer_en: `🎭 Both "hide" parts of an image, but work differently:\n\n✂️ **Clipping Mask:** uses a **shape (or text)** to crop an image/color so it only shows *inside* that shape.\n- e.g. pour a photo inside the word "LOVE".\n- Image on top → Alt-click between the 2 layers (Photoshop), or Object → Clipping Mask (Illustrator).\n\n⚫⚪ **Layer Mask:** uses **grayscale** (white/black) to reveal/hide parts **non-destructively**.\n- **White = show, black = hide, gray = semi-transparent.**\n- Best for smoothly blending two images by painting black on the mask with a brush.\n\n💡 **Pro Tip:** Use a **clipping mask** to pour an image into a shape; use a **layer mask** to remove a background or blend a gradient *without destroying* the original.`,
        chips: ['តើ Layer Mask ប្រើសម្រាប់អ្វី? 🎭', 'របៀបលុបផ្ទៃខាងក្រោយរូបភាព (Remove Background)? ✂️', 'តើការកាត់តរូបបែប Non-Destructive ជាអ្វី? 🔄'],
        chips_en: ['How to use Layer Masks? 🎭', 'How to remove background from photos? ✂️', 'What is Non-Destructive Editing? 🔄']
    },
    {
        primaryKeys: ['តើ Pathfinder (Boolean) ប្រើយ៉ាងម៉េច? ⬡', 'How to use Pathfinder (Boolean) operations? ⬡'],
        keys: ['pathfinder', 'boolean', 'unite', 'minus front', 'intersect', 'shape builder', 'combine shapes', 'subtract shape', 'បញ្ចូលរូបរាង'],
        regex: ['^pathfinder$', 'boolean\\s*(operation|shape)?', 'shape\\s*builder', 'unite.*shape', 'minus\\s*front'],
        answer: `⬡ **Pathfinder** ប្រើ Shape សាមញ្ញ (រង្វង់, ការ៉េ) មក "ផ្សំ/កាត់" គ្នាបង្កើតរូបរាងស្មុគស្មាញ — បេះដូងនៃការគូរ Logo & Icon!\n\n🔧 **Operations សំខាន់ៗ:**\n- **Unite (Union):** ភ្ជាប់ Shape ច្រើនជា ១។\n- **Minus Front:** Shape ខាងលើ "កាត់ចោល" Shape ខាងក្រោម (បង្កើតប្រហោង)។\n- **Intersect:** សល់តែផ្នែកត្រួតគ្នា។\n- **Exclude:** លុបផ្នែកត្រួតគ្នា (បង្កើតប្រហោងកណ្ដាល)។\n\n⚡ **Shape Builder Tool (Shift+M):** ល្អជាង Pathfinder — អូស Mouse ដើម្បីផ្សំ ឬចុច Alt+អូស ដើម្បីលុប, មើលឃើញ Live!\n\n💡 **គន្លឹះអ្នកជំនាញ:** Icon ល្អៗស្ទើរតែទាំងអស់ កើតពី Shape សាមញ្ញ ៣–៤ ផ្សំគ្នាដោយ Pathfinder។ ចាប់ផ្ដើមពី Shape មូលដ្ឋាន កុំគូរ Freehand!`,
        answer_en: `⬡ **Pathfinder** combines simple shapes (circles, squares) to "build/cut" complex forms — the heart of logo & icon drawing!\n\n🔧 **Key operations:**\n- **Unite (Union):** merge multiple shapes into one.\n- **Minus Front:** the top shape "punches a hole" through the one below.\n- **Intersect:** keep only the overlapping area.\n- **Exclude:** remove the overlap (creates a hole in the middle).\n\n⚡ **Shape Builder Tool (Shift+M):** often better than Pathfinder — drag to merge, Alt-drag to delete, all live!\n\n💡 **Pro Tip:** Almost every clean icon is just 3–4 simple shapes combined with Pathfinder. Start from basic shapes — don't draw freehand!`,
        chips: ['របៀបប្រើ Pen Tool និង Anchor Points ឱ្យស្ទាត់ 🖊️', 'ប្រភេទឡូហ្គោ (Logo Types) 🔣', 'តើ Iconography គឺជាអ្វី? 🔣'],
        chips_en: ['How to master the Pen Tool & Anchor Points? 🖊️', 'Logo Types 🔣', 'What is Iconography? 🔣']
    },
    {
        primaryKeys: ['ឧបករណ៍ជ្រើសរើស (Selection Tools) មានអ្វីខ្លះ? 🪄', 'Photoshop Selection Tools explained? 🪄'],
        keys: ['selection tool', 'magic wand', 'lasso', 'quick selection', 'marquee', 'select subject', 'object selection', 'ឧបករណ៍ជ្រើស', 'ច្រឹប'],
        regex: ['selection\\s*tools?', 'magic\\s*wand', '^lasso$', 'quick\\s*selection', 'select\\s*subject', 'marquee'],
        answer: `🪄 **Selection Tools** ក្នុង Photoshop ៖ ជ្រើស "តែផ្នែកដែលបងចង់កែ"។\n\n- **Marquee (M):** ជ្រើសការ៉េ/រង្វង់ ត្រង់ៗ។\n- **Lasso (L):** គូរដោយដៃ; **Polygonal Lasso** សម្រាប់ជ្រុងត្រង់ៗ។\n- **Magic Wand (W):** ជ្រើសតាម **ពណ៌ដូចគ្នា** (ល្អសម្រាប់ Background ពណ៌តែមួយ)។\n- **Quick Selection (W):** អូស Brush → AI ស្វែងរកគែមឱ្យ។\n- **Object Selection / Select Subject:** AI ជ្រើស Subject ស្វ័យប្រវត្តិ (ល្អបំផុតឥឡូវ!)។\n\n🎯 **បន្ទាប់ពីជ្រើស:** ប្រើ **Select → Modify → Feather** ដើម្បីឱ្យគែមរលូន, ឬ **Select and Mask** ដើម្បីច្រឹបសក់ឱ្យម៉ត់។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ជានិច្ចកាល ប្ដូរ Selection ទៅ **Layer Mask** (មិនមែនលុបចោល) — Non-Destructive ងាយកែក្រោយ!`,
        answer_en: `🪄 **Selection tools** in Photoshop let you edit "only the part you want".\n\n- **Marquee (M):** straight rectangle/ellipse selections.\n- **Lasso (L):** freehand; **Polygonal Lasso** for straight edges.\n- **Magic Wand (W):** selects by **similar color** (great for a solid background).\n- **Quick Selection (W):** brush over an area → AI finds the edges.\n- **Object Selection / Select Subject:** AI auto-selects the subject (the best option today!).\n\n🎯 **After selecting:** use **Select → Modify → Feather** for soft edges, or **Select and Mask** to cleanly cut out hair.\n\n💡 **Pro Tip:** Always turn a selection into a **Layer Mask** (don't delete pixels) — non-destructive and easy to fix later!`,
        chips: ['របៀបលុបផ្ទៃខាងក្រោយរូបភាព (Remove Background)? ✂️', 'តើ Layer Mask ប្រើសម្រាប់អ្វី? 🎭', 'តើការកាត់តរូបបែប Non-Destructive ជាអ្វី? 🔄'],
        chips_en: ['How to remove background from photos? ✂️', 'How to use Layer Masks? 🎭', 'What is Non-Destructive Editing? 🔄']
    },
    {
        primaryKeys: ['តើ Adjustment Layers, Curves និង Levels ជាអ្វី? 🎚️', 'What are Adjustment Layers, Curves & Levels? 🎚️'],
        keys: ['adjustment layer', 'curves', 'levels', 'color correction', 'tone correction', 'brightness contrast', 'កែពណ៌', 'កែពន្លឺ'],
        regex: ['adjustment\\s*layers?', '^curves$', '^levels$', 'color\\s*correction', 'tone\\s*correction'],
        answer: `🎚️ **Adjustment Layers** ៖ កែ ពណ៌/ពន្លឺ ដោយ **Non-Destructive** (មិនប៉ះរូបដើម — អាចបិទ/កែ/លុបបានគ្រប់ពេល)។\n\nបង្កើតពី Layers Panel → រូប ⊘ ពាក់កណ្ដាលខ្មៅ។\n\n**ពីរ Tool សំខាន់បំផុត:**\n- **Levels:** ៣ Slider — ខ្មៅ (Shadow), ប្រផេះ (Midtone), ស (Highlight)។ អូស Slider ខ្មៅ/ស ចូលក្នុង → បន្ថែម Contrast ភ្លាម។\n- **Curves:** ឧបករណ៍ខ្លាំងបំផុត — បន្ទាត់អង្កាញ់ដែលគ្រប់គ្រងពន្លឺ Precise។ ទាញ S-Curve = Contrast ស្អាត; ទាញ Channel ដាច់ៗ (R/G/B) = Color Grading។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ប្រើ **Curves** ជា Adjustment Layer ហើយដាក់ **Layer Mask** លើវា → អាចកែពន្លឺតែផ្នែកណាមួយនៃរូប (ឧ. បំភ្លឺតែមុខ)!`,
        answer_en: `🎚️ **Adjustment Layers** edit color/brightness **non-destructively** (the original is untouched — toggle, tweak or delete anytime).\n\nCreate from the Layers panel → the half-black ⊘ circle icon.\n\n**The two most important:**\n- **Levels:** 3 sliders — black (shadows), gray (midtones), white (highlights). Drag black/white inward → instant contrast.\n- **Curves:** the most powerful tool — a graph line that controls tones precisely. An S-curve = nice contrast; pulling each channel (R/G/B) separately = color grading.\n\n💡 **Pro Tip:** Put a **Curves** adjustment layer with a **layer mask** on it → brighten only part of the image (e.g. just the face)!`,
        chips: ['តើការកាត់តរូបបែប Non-Destructive ជាអ្វី? 🔄', 'តើ Dodge & Burn ជាអ្វី? 🌗', 'តើ Blending Modes គឺជាអ្វី? 🎞️'],
        chips_en: ['What is Non-Destructive Editing? 🔄', 'What is Dodge & Burn? 🌗', 'What are Blending Modes? 🎞️']
    },

    // ───────────── PHOTO EDITING / RETOUCHING ─────────────
    {
        primaryKeys: ['តើ Dodge & Burn ជាអ្វី? 🌗', 'What is Dodge & Burn? 🌗'],
        keys: ['dodge', 'burn', 'dodge and burn', 'dodge burn', 'lighten darken', 'contouring', 'បំភ្លឺ', 'ធ្វើឱ្យងងឹត'],
        regex: ['dodge', '\\bburn\\b', 'dodge.*burn', 'lighten.*darken'],
        answer: `🌗 **Dodge & Burn** គឺបច្ចេកទេសចាស់ពីបន្ទប់ Darkroom៖\n- **Dodge** = ធ្វើឱ្យ **ភ្លឺ** (Highlight)។\n- **Burn** = ធ្វើឱ្យ **ងងឹត** (Shadow)។\n\nវាប្រើដើម្បីបង្កើត **ទំហំ (Dimension)** និង "Contour" ឱ្យរូបមើលទៅ ៣ វិមាត្រ — ល្បីខ្លាំងក្នុង Retouch មុខ (បន្ថែម Cheekbone, Jawline) និង Product។\n\n🛠️ **វិធី Non-Destructive:**\n១. បង្កើត Layer ថ្មី → Fill ពណ៌ **ប្រផេះ 50%** → Blend Mode **Soft Light**។\n២. ប្រើ Brush ស (Dodge) ឬ ខ្មៅ (Burn) Opacity ទាប ៥–១០% លាបស្រាលៗ។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ច្បាប់ "ពន្លឺមកពីលើ" — Dodge ផ្នែកខាងលើវត្ថុ, Burn ផ្នែកខាងក្រោម → ភ្លាមៗរូបមើលទៅមានបរិមាណ (Volume) និងថ្លៃ!`,
        answer_en: `🌗 **Dodge & Burn** is an old darkroom technique:\n- **Dodge** = make **lighter** (highlights).\n- **Burn** = make **darker** (shadows).\n\nIt builds **dimension** and "contours" so an image looks 3D — hugely popular in face retouching (enhancing cheekbones, jawlines) and product shots.\n\n🛠️ **Non-destructive method:**\n1. New layer → fill with **50% gray** → blend mode **Soft Light**.\n2. Paint with a white brush (dodge) or black brush (burn) at low 5–10% opacity, gently.\n\n💡 **Pro Tip:** Follow "light comes from above" — dodge the top of a form, burn the bottom → it instantly gains volume and a premium feel!`,
        chips: ['តើ Adjustment Layers, Curves និង Levels ជាអ្វី? 🎚️', 'តើ Frequency Separation ជាអ្វី? 🧴', 'តើ Blending Modes គឺជាអ្វី? 🎞️'],
        chips_en: ['What are Adjustment Layers, Curves & Levels? 🎚️', 'What is Frequency Separation? 🧴', 'What are Blending Modes? 🎞️']
    },
    {
        primaryKeys: ['តើ Frequency Separation (កែស្បែក) ជាអ្វី? 🧴', 'What is Frequency Separation (skin retouch)? 🧴'],
        keys: ['frequency separation', 'skin retouch', 'skin retouching', 'smooth skin', 'high frequency', 'low frequency', 'កែស្បែក', 'រលោងស្បែក'],
        regex: ['frequency\\s*separation', 'skin\\s*retouch', 'smooth\\s*skin', 'កែ.*ស្បែក'],
        answer: `🧴 **Frequency Separation** គឺបច្ចេកទេស Retouch ស្បែករបស់ Pro ៖ បំបែករូបជា ២ ស្រទាប់៖\n\n- **Low Frequency:** ផ្ទុក **ពណ៌ & ស្រមោល** (Tone)។\n- **High Frequency:** ផ្ទុក **Texture & details** (រន្ធញើស, រោម, មុន)។\n\nដោយបំបែកគ្នា បងអាចលុប **ស្នាមមុន/ពណ៌មិនស្មើ** លើ Low Layer **ដោយមិនបាត់ Texture ស្បែកពិត** — ស្បែករលោងតែ "មិនមែនជា Plastic"។\n\n🛠️ **រួមៗ (Photoshop):**\n១. Duplicate Layer ២ ដង។\n២. Layer ក្រោម → Gaussian Blur (Low)។\n③. Layer លើ → Apply Image (High)។\n④. កែ Tone លើ Low, កែ Texture លើ High។\n\n💡 **គន្លឹះអ្នកជំនាញ:** កុំ Blur ស្បែកទាំងមូល (មើលទៅ Fake)! Frequency Separation រក្សា Pore ពិត ដែលជាសញ្ញានៃ Retoucher អាជីព។`,
        answer_en: `🧴 **Frequency Separation** is the pro skin-retouch technique — it splits a photo into two layers:\n\n- **Low Frequency:** holds **color & shadow** (tone).\n- **High Frequency:** holds **texture & detail** (pores, hair, blemishes).\n\nBy separating them, you can fix **blemishes/uneven color** on the low layer **without destroying real skin texture** — smooth skin that still looks human, not plastic.\n\n🛠️ **In short (Photoshop):**\n1. Duplicate the layer twice.\n2. Bottom layer → Gaussian Blur (low).\n3. Top layer → Apply Image (high).\n4. Fix tone on low, fix texture on high.\n\n💡 **Pro Tip:** Never just blur the whole face (it looks fake)! Frequency separation keeps real pores — the hallmark of a professional retoucher.`,
        chips: ['តើ Dodge & Burn ជាអ្វី? 🌗', 'តើ Adjustment Layers, Curves និង Levels ជាអ្វី? 🎚️', 'តើការកាត់តរូបបែប Non-Destructive ជាអ្វី? 🔄'],
        chips_en: ['What is Dodge & Burn? 🌗', 'What are Adjustment Layers, Curves & Levels? 🎚️', 'What is Non-Destructive Editing? 🔄']
    },
    {
        primaryKeys: ['តើ Exposure Triangle (ISO, Aperture, Shutter) ជាអ្វី? 📷', 'What is the Exposure Triangle? 📷'],
        keys: ['exposure triangle', 'iso', 'aperture', 'shutter speed', 'f-stop', 'exposure', 'photography basics', 'ពន្លឺកាមេរ៉ា'],
        regex: ['exposure\\s*triangle', '^iso$', '^aperture$', 'shutter\\s*speed', 'f-?stop'],
        answer: `📷 **Exposure Triangle** គឺ ៣ Setting ដែលគ្រប់គ្រងពន្លឺ (និងរូបរាង) របស់រូបថត៖\n\n- **Aperture (f-stop):** ទំហំរន្ធ Lens។ f តូច (f/1.8) = ពន្លឺច្រើន + ផ្ទៃក្រោយ **ព្រិល (Bokeh)**។ f ធំ (f/16) = ច្បាស់ទាំងអស់។\n- **Shutter Speed:** ល្បឿនបិទ/បើក។ លឿន (1/1000) = បង្កក Action; យឺត (1/30) = ស្រអិល (Motion Blur)។\n- **ISO:** ភាពប្រែប្រួលនឹងពន្លឺ។ ទាប (100) = ស្អាត; ខ្ពស់ (3200+) = ភ្លឺក្នុងងងឹត តែមាន **Noise (គ្រាប់)**។\n\n⚖️ ប្ដូរ ១ → ត្រូវសងវិញ ១ ដើម្បីរក្សាពន្លឺឱ្យស្មើ។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ចង់បានរូប Portrait ផ្ទៃក្រោយព្រិលៗ? បើក Aperture ធំ (f/1.8–f/2.8) → Subject ច្បាស់ ផ្ទៃក្រោយ Bokeh ស្អាត!`,
        answer_en: `📷 **The Exposure Triangle** is the 3 settings that control a photo's light (and look):\n\n- **Aperture (f-stop):** lens opening size. Small f (f/1.8) = more light + a **blurry background (bokeh)**. Large f (f/16) = everything sharp.\n- **Shutter Speed:** how long the shutter stays open. Fast (1/1000) = freezes action; slow (1/30) = motion blur.\n- **ISO:** light sensitivity. Low (100) = clean; high (3200+) = brighter in the dark but adds **noise/grain**.\n\n⚖️ Change one → compensate with another to keep the exposure balanced.\n\n💡 **Pro Tip:** Want a portrait with a creamy blurred background? Open the aperture wide (f/1.8–f/2.8) → sharp subject, beautiful bokeh!`,
        chips: ['តើ Depth of Field គឺជាអ្វី? 📷', 'តើ Chromatic Aberration ជាអ្វី? 📷', 'តើ Rule of Thirds ប្រើយ៉ាងម៉េច? 📸'],
        chips_en: ['What is Depth of Field? 📷', 'What is Chromatic Aberration? 📷', 'How to use the Rule of Thirds? 📸']
    },

    // ───────────── PRINT & PRODUCTION ─────────────
    {
        primaryKeys: ['ប្រភេទបត់ Brochure (Bi-fold, Tri-fold) មានអ្វីខ្លះ? 📰', 'Brochure fold types (Bi-fold, Tri-fold)? 📰'],
        keys: ['brochure fold', 'bi-fold', 'tri-fold', 'gate fold', 'z-fold', 'accordion fold', 'leaflet', 'pamphlet', 'ប្រូស្ស័រ', 'បត់ក្រដាស'],
        regex: ['brochure\\s*fold', 'bi-?fold', 'tri-?fold', 'gate\\s*fold', 'z-?fold', 'accordion\\s*fold'],
        answer: `📰 **ប្រភេទបត់ Brochure** សំខាន់ៗ៖\n\n- **Bi-Fold:** បត់ ១ ដង → ៤ ផ្ទាំង (ដូចសៀវភៅ)។ ល្អសម្រាប់ Menu, Program។\n- **Tri-Fold:** បត់ ២ ដង → ៦ ផ្ទាំង។ ពេញនិយមបំផុតសម្រាប់ Company Profile។\n- **Z-Fold:** បត់រាងអក្សរ Z → បើកចេញវែងៗ (ល្អសម្រាប់ Timeline)។\n- **Gate-Fold:** ២ ផ្នែកបត់ចូលកណ្ដាល (បើកដូចទ្វារ) → Premium, Dramatic។\n- **Accordion:** បត់ច្រើនដងជា Zigzag → Catalog ច្រើនទំព័រ។\n\n📐 **ចំណាំ Tri-Fold:** ផ្ទាំងដែលបត់ចូលខាងក្នុង ត្រូវធ្វើ **តូចជាង ២mm** ដើម្បីកុំឱ្យក្រញ៉ាញ់!\n\n💡 **គន្លឹះអ្នកជំនាញ:** តែងតែបង្កើត **Mockup បត់ក្រដាសពិត** ឬ Dummy មុនព្រីនពេញ — Designer ច្រើនច្រឡំ Panel ខាងក្នុង/ខាងក្រៅ ខូចលុយព្រីនទាំងអស់!`,
        answer_en: `📰 **Common brochure fold types:**\n\n- **Bi-Fold:** one fold → 4 panels (like a book). Good for menus, programs.\n- **Tri-Fold:** two folds → 6 panels. The most popular for company profiles.\n- **Z-Fold:** folded like a "Z" → opens out flat (great for timelines).\n- **Gate-Fold:** two flaps fold into the center (opens like doors) → premium, dramatic.\n- **Accordion:** multiple zig-zag folds → multi-page catalogs.\n\n📐 **Tri-fold note:** the panel that folds *inside* must be **~2mm narrower** so it doesn't crease/buckle!\n\n💡 **Pro Tip:** Always build a **real folded paper dummy** before the full print run — designers constantly mix up inside/outside panels and waste the whole print budget!`,
        chips: ['តើ Bleed គឺជាអ្វី? ✂️', 'តើ Paper GSM និង Paper Grain ជាអ្វី? 📄', 'តើ RGB និង CMYK ខុសគ្នាម៉េច? 🖨️'],
        chips_en: ['What is a Bleed? ✂️', 'Paper Weight (GSM) and Grain? 📄', 'RGB vs CMYK? 🖨️']
    },
    {
        primaryKeys: ['ខ្នាត និងការរចនា Business Card (នាមប័ណ្ណ) 💼', 'Business Card sizes & design tips? 💼'],
        keys: ['business card', 'name card', 'card size', 'business card size', 'namecard', 'visiting card', 'នាមប័ណ្ណ', 'កាតឈ្មោះ'],
        regex: ['business\\s*card', 'name\\s*card', 'visiting\\s*card', 'card\\s*size', 'នាមប័ណ្ណ'],
        answer: `💼 **Business Card (នាមប័ណ្ណ)** គឺ "ការចាប់ដៃ" ដំបូងរបស់ Brand។\n\n📏 **ខ្នាតស្តង់ដារ:**\n- **US/Asia:** 3.5 × 2 inch (89 × 51 mm)។\n- **Europe:** 85 × 55 mm។\n- **Square Trend:** 55 × 55 mm។\n- **Bleed:** បន្ថែម 3mm ជុំវិញ (បានជា 91 × 53 mm សម្រាប់ Setup)។\n- **Safe Zone:** អក្សរ/Logo ត្រូវនៅខាងក្នុង 3–5mm ពីគែម។\n\n🎨 **ច្បាប់រចនា ៥ យ៉ាង:**\n១. ប្រើ **CMYK** + **300 DPI**។\n២. កុំដាក់ព័ត៌មានច្រើនពេក (ឈ្មោះ, តួនាទី, ទូរស័ព្ទ, Email, Logo គ្រប់គ្រាន់)។\n③. ទុក White Space ឱ្យដកដង្ហើម។\n④. ខាងមុខ = Logo/ឈ្មោះ; ខាងក្រោយ = Contact។\n⑤. Convert Font ទៅ Outline មុនផ្ញើព្រីន។\n\n💡 **គន្លឹះអ្នកជំនាញ:** Finish ពិសេស (Spot UV, Foil, Embossing, Edge Painting, ឬ Matte Lamination) ធ្វើឱ្យកាតមើលទៅ "ថ្លៃ" និងគេចាំ Brand បានយូរ!`,
        answer_en: `💼 **A business card** is a brand's first "handshake".\n\n📏 **Standard sizes:**\n- **US/Asia:** 3.5 × 2 in (89 × 51 mm).\n- **Europe:** 85 × 55 mm.\n- **Square trend:** 55 × 55 mm.\n- **Bleed:** add 3mm all around (→ 91 × 53 mm setup).\n- **Safe zone:** keep text/logo 3–5mm inside the edge.\n\n🎨 **5 design rules:**\n1. Use **CMYK** + **300 DPI**.\n2. Don't overload it (name, title, phone, email, logo — enough).\n3. Leave white space to breathe.\n4. Front = logo/name; back = contact.\n5. Convert fonts to outlines before sending to print.\n\n💡 **Pro Tip:** Special finishes (Spot UV, foil, embossing, edge painting, or matte lamination) make a card feel "premium" and far more memorable!`,
        chips: ['តើ Bleed គឺជាអ្វី? ✂️', 'តើបច្ចេកទេសបោះពុម្ពមានអ្វីខ្លះ? 🖨️', 'តើ Paper GSM និង Paper Grain ជាអ្វី? 📄'],
        chips_en: ['What is a Bleed? ✂️', 'Advanced print finishes? 🖨️', 'Paper Weight (GSM) and Grain? 📄']
    },
    {
        primaryKeys: ['តើ Rich Black និង Registration Black ខុសគ្នាម៉េច? ⬛', 'Rich Black vs Registration Black? ⬛'],
        keys: ['rich black', 'registration black', 'pure black', 'cmyk black', '100k black', 'black printing', 'ខ្មៅព្រីន', 'ខ្មៅជ្រៅ'],
        regex: ['rich\\s*black', 'registration\\s*black', '100k\\s*black', 'cmyk\\s*black'],
        answer: `⬛ ពណ៌ខ្មៅក្នុងការព្រីនមាន ៣ ប្រភេទ — ច្រឡំ = ខូចការងារ!\n\n- **Pure Black (K100):** C0 M0 Y0 **K100**។ ខ្មៅសុទ្ធតែ "ស្រាល" បន្តិច។ ✅ ប្រើសម្រាប់ **អក្សរតូចៗ & Body Text** (ច្បាស់, មិនច្រឡំ)។\n- **Rich Black:** ខ្មៅ + ពណ៌ផ្សេង (ឧ. **C60 M40 Y40 K100**)។ ✅ ខ្មៅ "ជ្រៅ" សម្រាប់ **ផ្ទៃធំៗ & Background**។\n- **Registration Black (All 100):** C100 M100 Y100 K100។ ❌ **កុំប្រើជា Design!** វាសម្រាប់តែ Printer Marks ប៉ុណ្ណោះ — ប្រើច្រើនទឹកថ្នាំ ហើយក្រដាសសើម/ហែក!\n\n💡 **គន្លឹះអ្នកជំនាញ:** អក្សរ Body ប្រើ **K100**; Background ខ្មៅធំៗ ប្រើ **Rich Black**។ កុំដាក់អក្សរតូចៗពណ៌ស លើ Rich Black ៤ ពណ៌ — បើ Registration ខុសបន្តិច អក្សរនឹងព្រិល (មាន "ស្រមោល")!`,
        answer_en: `⬛ Black in print has 3 forms — mixing them up ruins the job!\n\n- **Pure Black (K100):** C0 M0 Y0 **K100**. Solid but slightly "light". ✅ Use for **small text & body copy** (crisp, no misregistration).\n- **Rich Black:** black + other inks (e.g. **C60 M40 Y40 K100**). ✅ A "deep" black for **large areas & backgrounds**.\n- **Registration Black (all 100):** C100 M100 Y100 K100. ❌ **Never use in a design!** It's only for printer marks — too much ink, soaks/tears the paper!\n\n💡 **Pro Tip:** Body text = **K100**; large black backgrounds = **Rich Black**. Avoid tiny white text on a 4-color rich black — slight misregistration makes it blurry with a "shadow"!`,
        chips: ['តើ RGB និង CMYK ខុសគ្នាម៉េច? 🖨️', 'តើបច្ចេកទេស Trapping, Overprint និង Knockout ជាអ្វី? 🖨️', 'តើ Color Profiling (ICC) ជាអ្វី? 🎛️'],
        chips_en: ['RGB vs CMYK? 🖨️', 'Trapping, Overprint, and Knockout? 🖨️', 'What are ICC Color Profiles? 🎛️']
    },

    // ───────────── UI / UX SYSTEMS ─────────────
    {
        primaryKeys: ['តើ Accessibility (WCAG) ក្នុង Design ជាអ្វី? ♿', 'What is Accessibility (WCAG) in design? ♿'],
        keys: ['accessibility', 'wcag', 'a11y', 'inclusive design', 'contrast ratio', 'alt text', 'screen reader', 'ភាពងាយស្រួលប្រើ', 'accessible design'],
        regex: ['accessibility', '^wcag$', '^a11y$', 'inclusive\\s*design', 'contrast\\s*ratio', 'alt\\s*text'],
        answer: `♿ **Accessibility (A11y)** = រចនាឱ្យ **មនុស្សគ្រប់គ្នា** ប្រើបាន រួមទាំងអ្នកពិការភ្នែក, ពិការពណ៌, ឬប្រើ Screen Reader។ **WCAG** គឺស្តង់ដារអន្តរជាតិ។\n\n✅ **ច្បាប់សំខាន់ៗ ៥:**\n១. **Color Contrast:** អក្សរ ៖ ផ្ទៃក្រោយ ≥ **4.5:1** (អក្សរធំ ≥ 3:1)។\n២. **កុំពឹងលើពណ៌តែមួយ:** បន្ថែម Icon/Label (ឧ. Error កុំក្រហមសុទ្ធ — ដាក់ ⚠️ ផង)។\n③. **Text Size:** Body ≥ 16px, កុំ Justify ពេក។\n④. **Alt Text:** រៀបរាប់រូបសម្រាប់ Screen Reader។\n⑤. **Tap Target:** ប៊ូតុង ≥ 44×44px (ងាយចុចលើទូរស័ព្ទ)។\n\n💡 **គន្លឹះអ្នកជំនាញ:** Accessible Design មិនមែនជា "ការបន្ថែម" ទេ — វាធ្វើឱ្យ Design **ល្អជាងសម្រាប់មនុស្សគ្រប់គ្នា**។ Check ដោយ **WebAIM Contrast Checker** ឥតគិតថ្លៃ!`,
        answer_en: `♿ **Accessibility (a11y)** = designing so **everyone** can use it, including people with low vision, color blindness, or screen readers. **WCAG** is the international standard.\n\n✅ **5 key rules:**\n1. **Color contrast:** text-to-background ≥ **4.5:1** (large text ≥ 3:1).\n2. **Don't rely on color alone:** add icons/labels (e.g. an error shouldn't be just red — add ⚠️).\n3. **Text size:** body ≥ 16px, avoid heavy justification.\n4. **Alt text:** describe images for screen readers.\n5. **Tap targets:** buttons ≥ 44×44px (easy to tap on mobile).\n\n💡 **Pro Tip:** Accessible design isn't an "add-on" — it makes the design **better for everyone**. Check it free with the **WebAIM Contrast Checker**!`,
        chips: ['ពណ៌សម្រាប់អ្នកមានបញ្ហាភ្នែក (Color Accessibility) 👁️', 'តើ Design System ជាអ្វី? 🧩', 'តើ UI និង UX ខុសគ្នាដូចម្តេច? 📱'],
        chips_en: ['Color Accessibility & Contrast? 👁️', 'What is a Design System? 🧩', "UI vs UX: What's the difference? 📱"]
    },
    {
        primaryKeys: ['តើ Atomic Design (Atoms, Molecules) ជាអ្វី? ⚛️', 'What is Atomic Design? ⚛️'],
        keys: ['atomic design', 'atoms molecules organisms', 'brad frost', 'design system structure', 'component hierarchy', 'atomic'],
        regex: ['atomic\\s*design', 'atoms?\\s*molecules?', 'brad\\s*frost'],
        answer: `⚛️ **Atomic Design** (ដោយ Brad Frost) គឺវិធីរៀបចំ **Design System** ដោយធៀបនឹងគីមីវិទ្យា — សាងពីផ្នែកតូចទៅធំ៖\n\n- **Atoms (អាតូម):** ផ្នែកតូចបំផុត — ប៊ូតុង, Label, Input, ពណ៌, Font។\n- **Molecules (ម៉ូលេគុល):** Atoms ផ្សំគ្នា — ឧ. Search Bar (Input + Button)។\n- **Organisms (សារពាង្គកាយ):** Molecules ផ្សំ — ឧ. Header (Logo + Nav + Search)។\n- **Templates:** គ្រោងប្លង់ទំព័រ (គ្មាន Content ពិត)។\n- **Pages:** Template + Content ពិតប្រាកដ។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ការគិតបែប Atomic ធ្វើឱ្យ Design **ឯកភាព (Consistent)** និងងាយ Scale — កែ Atom ១ (ឧ. ពណ៌ប៊ូតុង) → ប្ដូរទាំង App ភ្លាម! ល្អបំផុតក្នុង Figma ជាមួយ Components & Variants។`,
        answer_en: `⚛️ **Atomic Design** (by Brad Frost) organizes a **design system** using a chemistry analogy — building from small to large:\n\n- **Atoms:** the smallest parts — buttons, labels, inputs, colors, fonts.\n- **Molecules:** atoms combined — e.g. a search bar (input + button).\n- **Organisms:** molecules combined — e.g. a header (logo + nav + search).\n- **Templates:** page skeletons (no real content).\n- **Pages:** template + real content.\n\n💡 **Pro Tip:** Thinking atomically keeps a design **consistent** and easy to scale — edit one atom (e.g. button color) → it updates the whole app instantly! Best done in Figma with Components & Variants.`,
        chips: ['តើ Design System ជាអ្វី? 🧩', 'តើ 8pt Grid System ជាអ្វី? 📱', 'តើ UI Motion Design ជាអ្វី? 🎬'],
        chips_en: ['What is a Design System? 🧩', 'What is the 8pt Grid System? 📱', 'What is UI Motion Design? 🎬']
    },
    {
        primaryKeys: ['Material Design និង Apple HIG ខុសគ្នាម៉េច? 📱', 'Material Design vs Apple HIG? 📱'],
        keys: ['material design', 'human interface guidelines', 'hig', 'apple design', 'google design', 'ios design', 'android design', 'platform guidelines'],
        regex: ['material\\s*design', 'human\\s*interface\\s*guidelines', '\\bhig\\b', '(ios|android)\\s*design'],
        answer: `📱 ក្រុមហ៊ុនធំៗមាន "ច្បាប់រចនា" ផ្លូវការ ដើម្បីឱ្យ App មើលទៅជាប់ Platform៖\n\n🤖 **Material Design (Google / Android):**\n- គំនិត "ក្រដាស & ទឹកថ្នាំ" — Layer មាន **Elevation (ស្រមោល)**, Animation រលូន។\n- ប៊ូតុង FAB (រង្វង់អណ្ដែត), Bottom Nav។\n- ដិតដាម, ប្រើពណ៌ច្រើន។\n\n🍎 **Human Interface Guidelines (Apple / iOS):**\n- ស្អាត, ស្រាល, ច្រើន White Space, ប្រើ **Blur/Translucency**។\n- ប៊ូតុងជា Text, Tab Bar ខាងក្រោម។\n- ផ្ដោតលើ Content ជាងតុបតែង។\n\n💡 **គន្លឹះអ្នកជំនាញ:** បើ Design App iOS — អនុវត្តតាម HIG; App Android — តាម Material។ កុំយក UI iOS ដាក់ Android ផ្ទាល់ (User នឹងមើលទៅ "ចម្លែង")! Figma មាន UI Kit ផ្លូវការទាំងពីរ ឥតគិតថ្លៃ។`,
        answer_en: `📱 Big companies publish official "design rules" so apps feel native to each platform:\n\n🤖 **Material Design (Google / Android):**\n- A "paper & ink" metaphor — layers have **elevation (shadows)**, smooth motion.\n- FAB buttons (floating circles), bottom nav.\n- Bolder, more colorful.\n\n🍎 **Human Interface Guidelines (Apple / iOS):**\n- Clean, light, lots of white space, uses **blur/translucency**.\n- Text-style buttons, bottom tab bar.\n- Content over decoration.\n\n💡 **Pro Tip:** Designing an iOS app — follow HIG; Android — follow Material. Don't drop an iOS UI straight into Android (users will feel it's "off")! Figma has free official UI kits for both.`,
        chips: ['តើ Design System ជាអ្វី? 🧩', 'តើ Responsive Design គឺជាអ្វី? 💻', 'តើ UI និង UX ខុសគ្នាដូចម្តេច? 📱'],
        chips_en: ['What is a Design System? 🧩', 'What is Responsive Design? 💻', "UI vs UX: What's the difference? 📱"]
    },
    {
        primaryKeys: ['តើ Skeuomorphism ជាអ្វី? 📲', 'What is Skeuomorphism? 📲'],
        keys: ['skeuomorphism', 'skeuomorphic', 'realistic ui', 'ui history', 'flat vs skeuomorphism', 'neumorphism vs skeuomorphism'],
        regex: ['skeuomorph', 'realistic\\s*ui', 'ui\\s*(history|style)\\s*evolution'],
        answer: `📲 **Skeuomorphism** = រចនា UI ឱ្យមើលទៅដូច **វត្ថុពិតក្នុងលោកពិត** (ស្រមោល, Texture, ៣ វិមាត្រ)។\n\nឧ. App Notes ចាស់ៗ មើលទៅដូចសៀវភៅស្បែកពិត; App Recorder ដូចមីក្រូហ្វូនពិត។ iOS ៦ (2012) ល្បីខ្លាំងពីរចនាបែបនេះ។\n\n📜 **ការវិវត្ត UI:**\n- **Skeuomorphism** (ពិត, ស្រមោល) → **Flat Design** (រាបស្មើ, ស្អាត, iOS 7+) → **Material** (Flat + ស្រមោលស្រាល) → **Neumorphism** (Soft 3D ត្រឡប់មកវិញខ្លះ)។\n\n🎯 **ការប្រើសព្វថ្ងៃ:** Skeuomorphism ត្រឡប់មកវិញខ្លះក្នុង App តន្ត្រី/ហ្គេម ដើម្បីបង្កើតអារម្មណ៍ "ស្ទាបបាន" (Tactile)។\n\n💡 **គន្លឹះអ្នកជំនាញ:** Skeuomorphism ជួយ **User ថ្មីយល់ភ្លាម** (ប៊ូតុងមើលទៅដូចចុចបាន)។ តែប្រើច្រើនពេក = មើលទៅ "ចាស់"។ លាយតិចៗជាមួយ Flat = ល្អបំផុត។`,
        answer_en: `📲 **Skeuomorphism** = designing a UI to look like **real-world objects** (shadows, textures, 3D).\n\nE.g. old Notes apps looked like real leather books; a recorder app like a real microphone. iOS 6 (2012) was famous for this.\n\n📜 **UI evolution:**\n- **Skeuomorphism** (realistic, shadows) → **Flat Design** (clean, flat, iOS 7+) → **Material** (flat + subtle shadows) → **Neumorphism** (soft 3D, a partial return).\n\n🎯 **Today:** skeuomorphism returns a bit in music/game apps to feel "tactile".\n\n💡 **Pro Tip:** Skeuomorphism helps **new users understand instantly** (a button looks pressable). But overdone = "dated". A light mix with flat design works best.`,
        chips: ['តើ Flat Design និង Neumorphism ជាអ្វី? 💠', 'តើ Glassmorphism ជាអ្វី? 🪟', 'តើ Affordance ក្នុង UX ជាអ្វី? 🚪'],
        chips_en: ['Flat Design vs Neumorphism? 💠', 'What is Glassmorphism? 🪟', 'What is Affordance in UX? 🚪']
    },
    {
        primaryKeys: ['តើ Affordance និង Signifier ក្នុង UX ជាអ្វី? 🚪', 'What is Affordance in UX? 🚪'],
        keys: ['affordance', 'signifier', 'norman door', 'don norman', 'perceived affordance', 'ui clue'],
        regex: ['affordance', 'signifier', 'norman\\s*door', 'don\\s*norman'],
        answer: `🚪 **Affordance** (ដោយ Don Norman) = "សញ្ញាបង្ហាញ" ដែលប្រាប់ User ថាវត្ថុមួយ **ប្រើយ៉ាងម៉េច** ដោយមិនបាច់ពន្យល់។\n\n- ប៊ូតុងមាន **ស្រមោល** → មើលទៅ "ចុចបាន"។\n- ប្រអប់ Input មាន **ស៊ុម** → មើលទៅ "វាយអក្សរបាន"។\n- Link **ខៀវ គូសបន្ទាត់** → មើលទៅ "ចុចបាន"។\n\n🚪 **"Norman Door":** ទ្វារដែលមាន Handle ឱ្យទាញ តែតាមពិតត្រូវរុញ → ច្រឡំ! នេះជា Affordance ខុស។ UI ល្អ = គ្មាន "Norman Door"។\n\n💡 **គន្លឹះអ្នកជំនាញ:** បើ User ត្រូវ "គិត" ថាវត្ថុមួយចុចបានឬអត់ — នោះ Affordance បងខ្សោយ។ ធ្វើឱ្យអ្វីដែលចុចបាន **មើលទៅខុសពី** អ្វីដែលចុចមិនបាន (ពណ៌, ស្រមោល, Cursor)។`,
        answer_en: `🚪 **Affordance** (coined by Don Norman) = the visual "clues" that tell users **how to use** something without instructions.\n\n- A button with a **shadow** → looks "pressable".\n- An input with a **border** → looks "typeable".\n- A **blue underlined** link → looks "clickable".\n\n🚪 **The "Norman Door":** a door with a pull handle that you're actually supposed to push → confusing! That's a bad affordance. Good UI has no "Norman Doors".\n\n💡 **Pro Tip:** If users have to "think" about whether something is clickable, your affordance is weak. Make clickable things **look clearly different** from non-clickable ones (color, shadow, cursor).`,
        chips: ['តើ Heuristic Evaluation របស់ Nielsen ជាអ្វី? 📋', 'តើ Dark Patterns ជាអ្វី? 🚫', 'តើ Skeuomorphism ជាអ្វី? 📲'],
        chips_en: ["What is Nielsen's Heuristic Evaluation? 📋", 'What are Dark Patterns? 🚫', 'What is Skeuomorphism? 📲']
    },

    // ───────────── BRANDING ─────────────
    {
        primaryKeys: ['Logo Construction Grid និង Responsive Logo ជាអ្វី? 📐', 'Logo construction grid & responsive logos? 📐'],
        keys: ['logo grid', 'logo construction', 'responsive logo', 'logo clear space', 'logo variations', 'logo system', 'ក្រឡាចត្រង្គ logo'],
        regex: ['logo\\s*(grid|construction|system|variation)', 'responsive\\s*logo', 'clear\\s*space'],
        answer: `📐 **Logo ល្អៗ មិនមែនគ្រាន់តែ ១ រូបទេ — វាជា "ប្រព័ន្ធ"៖**\n\n🔲 **Construction Grid:** គូរ Logo លើ Grid (រង្វង់/ការ៉េ) ដើម្បីឱ្យសមាមាត្រ **ល្អឥតខ្ចោះ និងធ្វើឡើងវិញបាន**។ បង្ហាញ Pro ខ្លាំងក្នុង Brand Guidelines។\n\n📏 **Clear Space:** តំបន់ទទេជុំវិញ Logo (ធម្មតា = កម្ពស់អក្សរ Logo) — កុំឱ្យអ្វីចូលជិត។\n\n📱 **Responsive Logo (សំខាន់ឥឡូវ!):** Logo ត្រូវមានច្រើន Version តាមទំហំ៖\n- **Full:** Logo + Tagline (សម្រាប់ Website Header)។\n- **Standard:** Logo + ឈ្មោះ។\n- **Icon/Mark:** និមិត្តសញ្ញាតែឯង (សម្រាប់ App Icon, Favicon, Profile Pic)។\n\n💡 **គន្លឹះអ្នកជំនាញ:** តែងតែ Design Logo ឱ្យ **ច្បាស់ពេលតូច ១៦×១៦px** (Favicon)។ បើ Logo ស្មុគស្មាញពេក ពេលតូចមើលមិនច្បាស់ → ត្រូវ Simplify!`,
        answer_en: `📐 **A great logo isn't one image — it's a "system":**\n\n🔲 **Construction Grid:** draw the logo on a grid (circles/squares) for **perfect, reproducible** proportions. Looks very pro in brand guidelines.\n\n📏 **Clear Space:** empty zone around the logo (often = the logo's letter height) — let nothing crowd it.\n\n📱 **Responsive Logo (essential today!):** the logo needs multiple versions by size:\n- **Full:** logo + tagline (website header).\n- **Standard:** logo + name.\n- **Icon/Mark:** the symbol alone (app icon, favicon, profile pic).\n\n💡 **Pro Tip:** Always design the logo to stay clear at **16×16px** (favicon). If it's too complex to read when tiny → simplify it!`,
        chips: ['ប្រភេទឡូហ្គោ (Logo Types) 🔣', 'របៀបរចនា Logo ពីដំបូងដល់ចប់ (Logo Process)? 🏷️', 'តើ Brand Guidelines ជាអ្វី? 📖'],
        chips_en: ['Logo Types 🔣', 'Logo design process step-by-step? 🏷️', 'What are Brand Guidelines? 📖']
    },
    {
        primaryKeys: ['តើ Negative Space Logo (FedEx Arrow) ជាអ្វី? 🔺', 'Negative space in logos (the FedEx arrow)? 🔺'],
        keys: ['negative space logo', 'fedex arrow', 'hidden logo', 'clever logo', 'logo negative space', 'figure ground', 'ឡូហ្គោលាក់'],
        regex: ['negative\\s*space\\s*logo', 'fedex\\s*arrow', 'hidden\\s*(symbol|logo)', 'figure[- ]ground'],
        answer: `🔺 **Negative Space Logos** ប្រើ **ចន្លោះទទេ** (រវាងវត្ថុ) ដើម្បីលាក់និមិត្តសញ្ញាទី ២ — ឆ្លាត, គេចាំ, បង្ហាញ "ប្រាជ្ញា" Brand!\n\n🏆 **ឧទាហរណ៍ល្បីៗ:**\n- **FedEx:** មាន **ព្រួញ** លាក់រវាង "E" និង "x" (តំណាងល្បឿន)។\n- **Amazon:** ព្រួញ a→z (លក់គ្រប់យ៉ាង) ហើយដូចស្នាមញញឹម។\n- **WWF:** ខ្លាឃ្មុំ Panda ប្រើ White Space។\n- **Toblerone:** ខ្លាឃ្មុំលាក់ក្នុងភ្នំ។\n\nនេះផ្អែកលើទ្រឹស្តី **Gestalt (Figure-Ground)** — ខួរក្បាលបំបែក "វត្ថុ" ចេញពី "ផ្ទៃក្រោយ"។\n\n💡 **គន្លឹះអ្នកជំនាញ:** កុំ "បង្ខំ" Negative Space! វាល្អបំផុតពេលនិមិត្តសញ្ញាលាក់ **ទាក់ទងនឹង Brand** (FedEx = ល្បឿន)។ ប្រើ Squint Test ដើម្បីពិនិត្យថា Shape ទាំងពីរច្បាស់។`,
        answer_en: `🔺 **Negative space logos** use the **empty space** (between elements) to hide a second symbol — clever, memorable, and shows brand "wit"!\n\n🏆 **Famous examples:**\n- **FedEx:** a hidden **arrow** between the "E" and "x" (speed).\n- **Amazon:** an a→z arrow (sells everything) that's also a smile.\n- **WWF:** a panda built from white space.\n- **Toblerone:** a bear hidden in the mountain.\n\nThis relies on **Gestalt (figure-ground)** theory — the brain separates "object" from "background".\n\n💡 **Pro Tip:** Don't "force" negative space! It works best when the hidden symbol **relates to the brand** (FedEx = speed). Use the Squint Test to check both shapes read clearly.`,
        chips: ['តើទ្រឹស្តី Gestalt ជាអ្វី? 🧩', 'តើ Squint Test ជាអ្វី? 👁️', 'ប្រភេទឡូហ្គោ (Logo Types) 🔣'],
        chips_en: ['Explain Gestalt Psychology 🧩', 'What is the Squint Test? 👁️', 'Logo Types 🔣']
    },

    // ───────────── HISTORY & THEORY ─────────────
    {
        primaryKeys: ['Designer ល្បីៗក្នុងប្រវត្តិសាស្ត្រ មាននរណាខ្លះ? 👑', 'Who are the most famous graphic designers? 👑'],
        keys: ['famous designers', 'paul rand', 'saul bass', 'massimo vignelli', 'paula scher', 'milton glaser', 'designer ល្បី', 'graphic design legends'],
        regex: ['famous\\s*(graphic\\s*)?designers?', 'paul\\s*rand', 'saul\\s*bass', 'vignelli', 'milton\\s*glaser', 'paula\\s*scher'],
        answer: `👑 **Designer ដែលផ្លាស់ប្ដូរវិស័យ — គួរសិក្សា:**\n\n- **Paul Rand:** "បិតា" Corporate Logo — IBM, ABC, UPS, NeXT (Steve Jobs ជួល)។ "Design is the silent ambassador of your brand."\n- **Saul Bass:** Logo & Movie Title ល្បីៗ — AT&T, Bell, Title រឿង Hitchcock។\n- **Massimo Vignelli:** ស្ដេច Swiss Style — NYC Subway Map, American Airlines។ "If you can design one thing, you can design everything."\n- **Milton Glaser:** បង្កើត Logo **"I ❤️ NY"** ដ៏ល្បីពិភពលោក។\n- **Paula Scher:** Pentagram — Citibank, Identity ភ្ជាប់ Typography ខ្លាំង។\n\n💡 **គន្លឹះអ្នកជំនាញ:** សិក្សា Designer ទាំងនេះមិនមែនដើម្បី Copy ទេ — តែដើម្បីយល់ **"ហេតុអ្វី"** ស្នាដៃរបស់ពួកគេនៅគង់វង្សរាប់សិបឆ្នាំ៖ Simple, មានន័យ, និងគ្មានពេលវេលា (Timeless)។`,
        answer_en: `👑 **The designers who shaped the field — worth studying:**\n\n- **Paul Rand:** the "father" of corporate logos — IBM, ABC, UPS, NeXT (hired by Steve Jobs). "Design is the silent ambassador of your brand."\n- **Saul Bass:** iconic logos & film titles — AT&T, Bell, Hitchcock title sequences.\n- **Massimo Vignelli:** the king of Swiss Style — the NYC Subway map, American Airlines. "If you can design one thing, you can design everything."\n- **Milton Glaser:** created the world-famous **"I ❤️ NY"** logo.\n- **Paula Scher:** Pentagram — Citibank, identity work driven by bold typography.\n\n💡 **Pro Tip:** Study these designers not to copy — but to understand **"why"** their work has lasted decades: simple, meaningful, and timeless.`,
        chips: ['តើ Graphic Design មានប្រវត្តិយ៉ាងណា? 📜', 'ចលនារចនា (Design Movements) ល្បីៗ មានអ្វីខ្លះ? 🏛️', 'ប្រភេទឡូហ្គោ (Logo Types) 🔣'],
        chips_en: ['What is the history of Graphic Design? 📜', 'Famous design movements (Bauhaus, Swiss)? 🏛️', 'Logo Types 🔣']
    },
    {
        primaryKeys: ['ចលនារចនា (Design Movements) ល្បីៗ មានអ្វីខ្លះ? 🏛️', 'Famous design movements (Bauhaus, Swiss)? 🏛️'],
        keys: ['design movement', 'bauhaus', 'swiss style', 'international typographic', 'art deco', 'art nouveau', 'memphis', 'constructivism', 'ចលនារចនា', 'រចនាបថ'],
        regex: ['design\\s*movements?', 'bauhaus', 'swiss\\s*style', 'art\\s*deco', 'art\\s*nouveau', 'constructivism', '\\bmemphis\\b'],
        answer: `🏛️ **ចលនារចនា (Design Movements)** សំខាន់ៗដែលនៅមានឥទ្ធិពលដល់សព្វថ្ងៃ៖\n\n- **Bauhaus (1919, អាល្លឺម៉ង់):** "Form follows function" — សាមញ្ញ, ធរណីមាត្រ, គ្មានតុបតែងលើស។ ឫសគល់នៃ Modern Design។\n- **Swiss / International Style (1950s):** Grid System, Helvetica, Asymmetry, ស្អាតស្អំ។ ឫសគល់ Corporate Design។\n- **Art Deco (1920s):** ប្រណីត, ខ្សែមាស, ធរណីមាត្រលំអ (Gatsby)។\n- **Art Nouveau (1890s):** ខ្សែកោងធម្មជាតិ, ផ្កា, ស្ត្រី។\n- **Constructivism (រុស្ស៊ី):** ក្រហម/ខ្មៅ, ទ្រេត, Propaganda Poster។\n- **Memphis (1980s):** ពណ៌ផ្ទុះ, Pattern, រាងចម្លែក (ត្រឡប់មកវិញ Trend ឥឡូវ!)។\n\n💡 **គន្លឹះអ្នកជំនាញ:** Trend សព្វថ្ងៃភាគច្រើនកើតឡើងវិញពីអតីតកាល។ ស្គាល់ Movement ទាំងនេះ → បងអាចបង្កើត Design "មាន Concept" ជំនួសឱ្យ "គ្រាន់តែស្អាត"!`,
        answer_en: `🏛️ **Key design movements** that still influence us today:\n\n- **Bauhaus (1919, Germany):** "Form follows function" — simple, geometric, no excess decoration. The root of modern design.\n- **Swiss / International Style (1950s):** grid systems, Helvetica, asymmetry, immaculate cleanliness. The root of corporate design.\n- **Art Deco (1920s):** luxurious, gold lines, ornate geometry (Gatsby).\n- **Art Nouveau (1890s):** natural curves, flowers, female figures.\n- **Constructivism (Russia):** red/black, diagonals, propaganda posters.\n- **Memphis (1980s):** loud colors, patterns, odd shapes (back in trend now!).\n\n💡 **Pro Tip:** Most of today's trends are revivals of the past. Knowing these movements lets you create design "with a concept" instead of "just pretty"!`,
        chips: ['Designer ល្បីៗក្នុងប្រវត្តិសាស្ត្រ មាននរណាខ្លះ? 👑', 'តើ Graphic Design មានប្រវត្តិយ៉ាងណា? 📜', 'តើ Swiss Style (Grid) ជាអ្វី? 📐'],
        chips_en: ['Who are the most famous graphic designers? 👑', 'What is the history of Graphic Design? 📜', 'What is a Grid System? 📐']
    },

    // ───────────── PROCESS, CAREER & AI ─────────────
    {
        primaryKeys: ['តើ Design Thinking (ដំណើរការគិត) ជាអ្វី? 💭', 'What is the Design Thinking process? 💭'],
        keys: ['design thinking', 'empathize define ideate', 'problem solving design', 'ideo', 'double diamond', 'ដំណើរការគិតរចនា'],
        regex: ['design\\s*thinking', 'empathi[sz]e', 'double\\s*diamond', 'ideate'],
        answer: `💭 **Design Thinking** គឺដំណើរការដោះស្រាយបញ្ហាដោយផ្ដោតលើ **មនុស្ស (User)** — មាន ៥ ដំណាក់កាល៖\n\n១. **Empathize (យល់ចិត្ត):** ស្រាវជ្រាវ User ពិត — តើគេមានបញ្ហាអ្វី?\n២. **Define (កំណត់):** សង្ខេបបញ្ហាជាក់លាក់ ("User ត្រូវការ...")។\n③. **Ideate (បំភ្លឺគំនិត):** Brainstorm គំនិតច្រើនតាមអាច — កុំវិនិច្ឆ័យ!\n④. **Prototype (គំរូ):** ធ្វើ Mockup/Wireframe លឿនៗ ដើម្បីសាក។\n⑤. **Test (សាកល្បង):** ឱ្យ User ពិតប្រើ → រៀនពីកំហុស → ធ្វើឡើងវិញ។\n\nវាមិនមែនជាបន្ទាត់ត្រង់ទេ — ជា **Loop** ដែលធ្វើម្ដងហើយម្ដងទៀត។\n\n💡 **គន្លឹះអ្នកជំនាញ:** Design មិនមែនចាប់ផ្ដើមពី "ធ្វើឱ្យស្អាត" ទេ — ផ្ដើមពី **"ដោះស្រាយបញ្ហាអ្វី សម្រាប់នរណា"**។ Design ស្អាតដែលដោះស្រាយខុសបញ្ហា = បរាជ័យ!`,
        answer_en: `💭 **Design Thinking** is a human-centered problem-solving process — 5 stages:\n\n1. **Empathize:** research real users — what problem do they have?\n2. **Define:** frame the specific problem ("the user needs…").\n3. **Ideate:** brainstorm as many ideas as possible — don't judge yet!\n4. **Prototype:** build quick mockups/wireframes to test.\n5. **Test:** let real users try it → learn from failures → repeat.\n\nIt's not a straight line — it's a **loop** you run again and again.\n\n💡 **Pro Tip:** Design doesn't start with "make it pretty" — it starts with **"what problem, for whom"**. A beautiful design that solves the wrong problem is a failure!`,
        chips: ['តើដំណើរការរចនា UX មានប៉ុន្មានជំហាន? ⚙️', 'តើ Design Brief គឺជាអ្វី? 📝', 'តើ User Persona គឺជាអ្វី? 👤'],
        chips_en: ['What is the UX Design Process? ⚙️', 'What is a Design Brief? 📝', 'What is a User Persona? 👤']
    },
    {
        primaryKeys: ['របៀបដោះស្រាយ Creative Block (គាំងគំនិត)? 🧱', 'How to overcome creative block? 🧱'],
        keys: ['creative block', 'designers block', 'art block', 'no ideas', 'stuck creatively', 'lack inspiration', 'គាំងគំនិត', 'អស់គំនិត'],
        regex: ['creative\\s*block', 'designers?\\s*block', 'art\\s*block', 'stuck\\s*creativ', 'គាំង.*គំនិត'],
        answer: `🧱 **Creative Block** កើតឡើងចំពោះ Designer គ្រប់រូប — វាមិនមែនជាសញ្ញាថាបងខ្សោយទេ! នេះជា ៧ វិធីដោះស្រាយ៖\n\n១. **ឈប់សម្រាក:** ដើរលេង, ងូតទឹក, ដេក — គំនិតល្អៗច្រើនកើតពេលឈប់គិត។\n២. **មើល Reference:** Behance, Pinterest, Dribbble — បំពេញ "ធុង" គំនិត។\n③. **កំណត់ Constraint:** "ប្រើតែ ២ ពណ៌" — ដែនកំណត់បង្កើនការច្នៃប្រឌិត។\n④. **ចាប់ផ្ដើមអាក្រក់:** គូរ Thumbnail ៥០ ដោយដៃ លឿនៗ កុំខ្វល់ស្អាត។\n⑤. **ប្ដូរបរិយាកាស:** ធ្វើការកន្លែងផ្សេង, ស្ដាប់តន្ត្រី។\n⑥. **ដោះស្រាយផ្នែកតូច:** ផ្ដោតលើ ១ ធាតុ (ឧ. ត្រឹមតែ Headline)។\n⑦. **រកមើល Limitation:** ត្រឡប់ទៅ Brief — ច្បាប់ច្រើនតែជា Springboard។\n\n💡 **គន្លឹះអ្នកជំនាញ:** "Done is better than perfect." ការចាប់ផ្ដើមជាមួយគំនិតមិនល្អ ល្អជាងការមិនចាប់ផ្ដើមសោះ — គំនិតល្អកើតពេលដៃកំពុងធ្វើ!`,
        answer_en: `🧱 **Creative block** hits every designer — it's not a sign you're bad at this! 7 ways to beat it:\n\n1. **Take a break:** walk, shower, sleep — great ideas come when you stop forcing it.\n2. **Look at references:** Behance, Pinterest, Dribbble — refill your "idea tank".\n3. **Add a constraint:** "use only 2 colors" — limits boost creativity.\n4. **Start badly:** sketch 50 quick thumbnails by hand, don't worry about pretty.\n5. **Change your environment:** work somewhere else, play music.\n6. **Solve a small piece:** focus on one element (just the headline).\n7. **Re-read the brief:** constraints are often a springboard.\n\n💡 **Pro Tip:** "Done is better than perfect." Starting with a bad idea beats not starting at all — good ideas appear while your hands are moving!`,
        chips: ['រក Inspiration / គំនិត Design ពីណា? 💡', 'មានអារម្មណ៍ថាស្មុគស្មាញ រៀនមិនចេះចប់ 🤯', 'តើ Perfectionism (ភាពល្អឥតខ្ចោះ) ជាឧបសគ្គឬ? 🚧'],
        chips_en: ['Where to find design inspiration? 💡', 'Feeling overwhelmed by design 🤯', 'Is perfectionism an obstacle? 🚧']
    },
    {
        primaryKeys: ['ឧបករណ៍ AI សម្រាប់ Designer មានអ្វីខ្លះ? 🤖', 'Best AI tools for graphic designers? 🤖'],
        keys: ['ai tools', 'ai design tools', 'dall-e', 'midjourney', 'stable diffusion', 'firefly', 'adobe firefly', 'ai upscale', 'generative ai', 'ai vectorize', 'ឧបករណ៍ ai'],
        regex: ['ai\\s*tools?', 'dall-?e', 'stable\\s*diffusion', 'firefly', 'generative\\s*ai', 'ai\\s*(upscal|vectoriz|design)'],
        answer: `🤖 **AI មិនជំនួស Designer ទេ — តែ Designer ដែលប្រើ AI នឹងជំនួសអ្នកដែលមិនប្រើ!** ឧបករណ៍សំខាន់ៗ៖\n\n🎨 **បង្កើតរូប (Image Gen):**\n- **Midjourney** — គុណភាពសិល្បៈខ្ពស់បំផុត។\n- **Adobe Firefly** — ស្របច្បាប់ (Train លើ Adobe Stock), រួមក្នុង Photoshop (Generative Fill!)។\n- **DALL-E 3 / Stable Diffusion** — បត់បែន, Control ច្រើន។\n\n🛠️ **ឧបករណ៍ជំនួយ:**\n- **Generative Fill (Photoshop):** ពង្រីក/លុប/បន្ថែមផ្នែករូប។\n- **Upscale:** Topaz Gigapixel, Magnific — ពង្រីករូបតូចឱ្យច្បាស់។\n- **Remove BG:** remove.bg, Photoshop។\n- **Vectorize:** Vectorizer.ai, Illustrator Image Trace។\n- **Khroma, Huemint** — បង្កើត Color Palette ដោយ AI។\n\n💡 **គន្លឹះអ្នកជំនាញ:** ប្រើ AI សម្រាប់ **គំនិត, Mockup លឿន, និងកិច្ចការធុញ** — រួចបន្ថែម **រសជាតិមនុស្ស (Taste, Concept, Brand Strategy)** ដែល AI ធ្វើមិនបាន។ នោះហើយជាតម្លៃ Designer ពិត!`,
        answer_en: `🤖 **AI won't replace designers — but designers who use AI will replace those who don't!** Key tools:\n\n🎨 **Image generation:**\n- **Midjourney** — the highest artistic quality.\n- **Adobe Firefly** — commercially safe (trained on Adobe Stock), built into Photoshop (Generative Fill!).\n- **DALL-E 3 / Stable Diffusion** — flexible, lots of control.\n\n🛠️ **Helper tools:**\n- **Generative Fill (Photoshop):** extend/remove/add parts of an image.\n- **Upscale:** Topaz Gigapixel, Magnific — enlarge small images sharply.\n- **Remove BG:** remove.bg, Photoshop.\n- **Vectorize:** Vectorizer.ai, Illustrator Image Trace.\n- **Khroma, Huemint** — AI-generated color palettes.\n\n💡 **Pro Tip:** Use AI for **ideas, fast mockups, and boring tasks** — then add the **human layer (taste, concept, brand strategy)** AI can't. That's the real value of a designer!`,
        chips: ['តើ AI នឹងដណ្តើមការងារ Designer ទេ? 🤖', 'របៀបសរសេរ Prompt សម្រាប់ Midjourney? 🤖', 'តើ AI Art មានកម្មសិទ្ធិបញ្ញាដែរឬទេ? 🤖⚖️'],
        chips_en: ['Will AI replace designers? 🤖', 'Midjourney Prompting Tips? 🤖', 'Can AI Art be copyrighted? 🤖⚖️']
    }
];