...
export const SUGGESTED_QUESTIONS = [
    ...
    "ចាប់ផ្តើមដោយរបៀបណា",
    "វិញ្ញាបនបត្ររចនា 🏆",
    "ហេតុអ្វីប្រើ Affinity លើ PC",
    "Affinity ធៀបនឹង Photoshop",
    "ប៊ូតុងបញ្ជា Modifier Keys ⌨️",
    "ម៉ឺនុយរហ័ស Context Menu 🖱️",
    "គន្លឹះក្តារចុចសំខាន់ៗ ⌨️",
    "របៀបបញ្ចូល Font ខ្មែរលើ PC 🔠",
    "Shortcut ផ្លូវកាត់សំខាន់ៗមានអ្វីខ្លះ?",
    "Artistic Text vs Frame Text",
    "របៀប Zoom និងរំកិលប្លង់លើ PC 🔍",
    "របៀបប្រើ Affinity លើ PC 💻",
...
export const SUGGESTED_QUESTIONS_EN = [
    ...
    "How to get started",
    "Design Certificate 🏆",
    "Why use Affinity on PC?",
    "Affinity vs Photoshop",
    "Affinity Modifier Keys ⌨️",
    "PC Context Menu Shortcuts",
    "Essential Keyboard Shortcuts ⌨️",
    "Installing Custom Fonts on PC 🔠",
    "Essential Keyboard Shortcuts",
    "Artistic Text vs Frame Text",
    "Zoom & Pan canvas on PC 🔍",
    "Affinity PC Shortcuts 💻",
