...
app.get('/health', (_, res) => res.json({ status: 'ok', keys: apiKeys.length }));
...
app.listen(PORT, () => {
    console.log(`🚀 Affinity Pro AI Backend running on port ${PORT} with ${apiKeys.length} API keys loaded.`);
});