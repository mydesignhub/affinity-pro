export const affinityIpadData = [
    // ==========================================
    // 1. IPAD SPECIFIC WORKFLOWS & GESTURES
    // ==========================================
    {
        ...
        chips_en: ["Affinity Command Controller 🎛️", "Managing iPad Studio Panels"]
    },
    {
        primaryKeys: ['Affinity Command Controller 🎛️', 'affinity command controller ipad'],
        keys: ['command controller', 'modifier key', 'ប៊ូតុងបញ្ជា ipad', 'shift on ipad'],
        regex: ['command controller', 'modifier', 'shift.*ipad'],
        answer: "បាទ **Command Controller គឺជាប៊ូតុងបញ្ជាវេទមន្តលើអេក្រង់ iPad!**\n\nដោយសារ iPad គ្មាន Keyboard ខាង Affinity បានបង្កើតប៊ូតុងមូលមួយនៅជ្រុងអេក្រង់ (អាចបើកបានក្នុង Document Menu > Toggle Command Controller)។\n\nវាតំណាងឱ្យប៊ូតុង Modifier ទាំង៤៖\n- **⇧ Shift:** សម្រាប់ទាញរូបឱ្យត្រង់ ឬរើសវត្ថុច្រើន។\n- **⌘ Command:** សម្រាប់ជ្រើសរើស (Select)។\n- **⌥ Option / Alt:** សម្រាប់ Copy រូបពេលទាញ ឬដកចេញ។\n- **⌃ Control:** សម្រាប់បើក Menu បន្ថែម។",
        answer_en: "**The Command Controller is your magical on-screen keyboard for the iPad!**\n\nSince iPads lack a physical keyboard, Affinity created a virtual joystick icon (Toggle it via Document Menu > Toggle Command Controller).\n\nIt replicates the 4 desktop modifier keys:\n- **⇧ Shift:** Constrain proportions or select multiple objects.\n- **⌘ Command:** Core selection tool.\n- **⌥ Option / Alt:** Duplicate objects while dragging, or subtract from a selection.\n- **⌃ Control:** Opens context menus.",
        chips: ["របៀបប្រើ Affinity លើ iPad 📱", "មុខងារ Quick Menu លើ iPad"],
        chips_en: ["Affinity iPad Gestures 📱", "iPad Quick Menu trick"]
    },
    {
        primaryKeys: ['មុខងារ Quick Menu លើ iPad', 'ipad quick menu trick'],
        keys: ['quick menu', 'អូសម្រាម៣', 'three finger swipe', 'លឿន'],
        regex: ['quick menu', 'អូសម្រាម៣', 'three finger swipe'],
        answer: "បាទ **Quick Menu (ម៉ឺនុយរហ័ស)** ជាមុខងារដែលលាក់ខ្លួនលើ iPad តែចំណេញពេលបំផុត!\n\nជំនួសឱ្យការចុចរកប៊ូតុង Copy, Paste ឬ Duplicate ពេញអេក្រង់ អ្នកគ្រាន់តែ **អូសម្រាមដៃ ៣ (Three-finger swipe down) ចុះក្រោម**។\n\n💡 វានឹងលោតផ្ទាំង Menu តូចមួយនៅចំកណ្តាលអេក្រង់ ដែលមានប៊ូតុងកាត់តសំខាន់ៗទាំងអស់ភ្លាមៗ (Copy, Paste, Duplicate, Delete)។",
        answer_en: "**The Quick Menu** is a hidden, massive time-saver on the iPad!\n\nInstead of hunting through top menus to copy or paste a layer, simply **Swipe Down with 3 Fingers** anywhere on the canvas.\n\n💡 This instantly summons a floating Quick Menu exactly where your hand is, giving you immediate access to Copy, Paste, Duplicate, and Delete!",
    ...
    // ==========================================
    {
        ...
        keys: ['export persona', 'slices', 'កាត់រូប export', 'save រូបច្រើន', 'export assets'],
        regex: ['export persona', 'slices', 'កាត់រូប export', 'save រូបច្រើន'],
        answer: "បាទ **Export Persona និងមុខងារ Slices គឺពិសេសបំផុតសម្រាប់ UI/UX Designers!**\n\nជំនួសឱ្យការ Save រូបទាំងមូល អ្នកអាចចូលទៅកាន់ Export Persona រួចគូសប្រអប់ (Slices) ពីលើប៊ូតុង ឬឡូហ្គោនីមួយៗដាច់ដោយឡែកពីគ្នា។\n\n💡 **គន្លឹះអាជីព៖** ពេលគូសរួច អ្នកអាចចុច Export តែម្តង វានឹងបញ្ចេញរូបភាពនោះទៅជាទម្រង់ 1x, 2x, 3x (សម្រាប់អេក្រង់ច្បាស់ Retina) ជា SVG ផង និង PNG ផង ក្នុងពេលតែមួយវិនាទី! វាសន្សំពេលរាប់ម៉ោង!",
        answer_en: "**The Export Persona and Slices tool is a game-changer for UI/UX Designers!**\n\nInstead of saving the entire canvas, you switch to the Export Persona and draw boxes (Slices) directly over individual buttons, icons, or logos.\n\n💡 **Pro Tip:** Once sliced, you can configure the output and click export to instantly save that one icon as a 1x, 2x, and 3x PNG, plus an SVG file, all simultaneously! It saves hours of manual saving.",
        chips: ["របៀបលក់ Digital Assets 💰", "តិចនិកប្រើ Affinity Personas 🚀"],
        chips_en: ["How to sell Digital Assets? 💰", "Tips for Affinity Personas 🚀"]
    },
    {
        ...
        chips_en: ["How to use the Assets Panel 📦", "Affinity Photo v3 Updates?"]
    },
    {
    ...
    // ==========================================
    {
        ...
        chips_en: ["What are Live Filters in Affinity?", "Designer Persona vs Pixel Persona"]
    },
    {
        primaryKeys: ['មុខងារ Artboards', 'affinity artboards'],
        keys: ['artboard', 'ផ្ទាំងច្រើន', 'how to use artboards'],
    ...
    },
    {
        ...
        keys: ['snapping', 'មេដែក', 'magnet tool', 'តម្រឹមស្វ័យប្រវត្តិ'],
        regex: ['snapping', 'មេដែក', 'magnet tool'],
        answer: "បាទ **Snapping (រូបមេដែក 🧲)** គឺជាមុខងារតម្រឹមស្វ័យប្រវត្តិដ៏ឆ្លាតវៃបំផុតរបស់ Affinity!\n\nនៅពេលអ្នកបើកវា ហើយអ្នកទាញវត្ថុមួយទៅក្បែរវត្ថុមួយទៀត វានឹងលោតខ្សែបន្ទាត់ពណ៌ក្រហមឬបៃតង ដើម្បីប្រាប់ថាវាត្រង់ជួរគ្នាហើយ (វាស្រូបទាញចូលគ្នាដូចមេដែក)។\n\n💡 **គន្លឹះអាជីព៖** បើអ្នកចង់ទាញវត្ថុដោយសេរីមួយភ្លែត ដោយមិនចង់ឱ្យវាស្រូបជាប់ អ្នកគ្រាន់តែ **ចុចបិទរូបមេដែកនោះជាបណ្ដោះអាសន្ន**!",
        answer_en: "**Snapping (The Magnet Icon 🧲)** is Affinity's brilliant automatic alignment feature!\n\nWhen enabled, dragging an object near another object or the center of the canvas will spawn red and green lines, and the object will physically 'snap' into perfect alignment.\n\n💡 **Pro Tip:** If Snapping is currently annoying you while making a tiny adjustment, simply **tap the magnet icon to disable it temporarily**!",
        chips: ["តើ Alignment ជាអ្វី?", "Shortcut ផ្លូវកាត់សំខាន់ៗមានអ្វីខ្លះ?"],
        chips_en: ["What is Alignment?", "Essential Keyboard Shortcuts"]
    },
    {
        primaryKeys: ['History Panel (Time Travel)', 'affinity history panel snapshot'],
        keys: ['history panel', 'snapshot', 'undo', 'ត្រលប់ក្រោយ', 'time travel'],
        regex: ['history panel', 'snapshot', 'undo', 'ត្រលប់'],
        answer: "បាទ **History Panel** នៅក្នុង Affinity ប្រៀបដូចជាម៉ាស៊ីនពេលវេលា (Time Machine) អញ្ចឹង!\n\nវាកត់ត្រារាល់សកម្មភាពរបស់អ្នករាប់ពាន់ដង។ អ្នកអាចអូសរបារត្រលប់ទៅមើលរូបភាពកាលពីម៉ោងមុនបាន។\n\n📷 **Snapshot:** បើអ្នកឌីហ្សាញបានពាក់កណ្តាលហើយខ្លាចខូច អ្នកអាចចុចប៊ូតុងកាមេរ៉ា 'Add Snapshot' នៅក្នុង History panel។ ពេលក្រោយ ទោះអ្នកកែរូបខូចដល់កម្រិតណាក៏ដោយ គ្រាន់តែចុចលើ Snapshot នោះ វានឹងលោតត្រលប់មកសភាពដើមវិញភ្លាមៗ!",
        answer_en: "**The History Panel** in Affinity is basically a Time Machine!\n\nIt saves thousands of your past actions. You can literally drag a slider back and forth to watch your entire design process happen in reverse.\n\n📷 **Snapshots:** If you reach a good point in your design but want to experiment, click the camera icon to 'Add Snapshot'. If you ruin the design, simply click that Snapshot to instantly restore your document to that exact perfect state!",
        chips: ["Shortcut ផ្លូវកាត់សំខាន់ៗមានអ្វីខ្លះ?", "តិចនិក Power Duplicate 🔄"],
        chips_en: ["Essential Keyboard Shortcuts", "The Power Duplicate trick 🔄"]
    },

    // ==========================================
    // 4. LAYERS, MASKS & SYMBOLS
    // ==========================================
    {
        primaryKeys: ['តើ Live Filters ក្នុង Affinity ជាអ្វី?', 'affinity live filters'],
        keys: ['live filter', 'live filters', 'ព្រិលរូបដោយមិនខូច', 'non-destructive filter'],
        regex: ['live filter', 'non-destructive filter'],
        answer: "បាទ **Live Filters គឺជាចំណុចខ្លាំងបំផុតរបស់ Affinity Photo ធៀបនឹងកម្មវិធីផ្សេង!**\n\nជាធម្មតា ពេលអ្នកដាក់ Gaussian Blur លើរូប វានឹងខូចសាច់រូបដើមរហូត។ ប៉ុន្តែនៅក្នុង Affinity អ្នកអាចប្រើ **Live Filter Layer**។ \n\n💡 **អត្ថប្រយោជន៍:** វាដើរតួជា Layer មួយដាច់ដោយឡែក។ អ្នកអាចបើក/បិទវា, លុបវាចេញដោយប្រើ Layer Mask, ឬផ្លាស់ប្តូរកម្រិតភាពព្រិល (Blur Radius) នៅពេលណាក៏បាន ដោយមិនប៉ះពាល់សាច់រូបថតដើមសូម្បីមួយភីកសែល (100% Non-destructive)។",
        answer_en: "**Live Filters are Affinity Photo's biggest advantage over other software!**\n\nUsually, when you apply a Gaussian Blur to an image, the pixels are permanently altered. But in Affinity, you can use a **Live Filter Layer**.\n\n💡 **The Benefit:** It acts as an independent layer. You can toggle it on/off, mask it out, or adjust the blur radius months later, all without destroying a single pixel of the original photo (100% Non-destructive).",
        chips: ["តើ Smart Object ជាអ្វី?", "ព្រិល Background (Depth of Field)"],
        chips_en: ["What is a Smart Object?", "Depth of Field (Blur)"]
    },
    {
        ...
        chips_en: ["What are Live Filters in Affinity?", "Image Layer vs Pixel Layer"]
    },
    {
        ...
        chips: ["មុខងារ Artboards", "Master Pages ក្នុង Publisher"],
        chips_en: ["Affinity Artboards", "Master Pages in Publisher"]
    },
    { 
    ...
    // ==========================================
    {
        ...
        chips_en: ["Affinity Boolean Geometry", "Stroke vs Fill"]
    },
    {
    ...
    },
    {
        ...
        chips_en: ["Vector vs Raster?", "Image Layer vs Pixel Layer"]
    },
    {
        primaryKeys: ['Image Layer vs Pixel Layer', 'image layer vs pixel layer'],
        keys: ['image layer', 'pixel layer'],
    ...
    },
    {
        ...
        chips_en: ["The Power Duplicate trick 🔄", "iPad Quick Menu trick"]
    },
    {
