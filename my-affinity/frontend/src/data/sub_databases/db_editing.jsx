export const editingData = [
    ...
    },
    {
        ...
        regex: ['ស្លេក', 'រូបស្លេកៗ', 'fade image', 'opacity fade'],
    ...
    },
    {
        ...
        regex: ['cast shadow', 'drop shadow', 'contact shadow', 'បង្កើតស្រមោល'], // Removed raw 'shadow'
    ...
    },
    {
        ...
        regex: ['មាស', 'ប្រាក់', 'gold effect', 'silver effect', 'metallic'],
    ...
    { 
        ...
        regex: ['cinematic', 'teal and orange', 'ពណ៌កុន'],
    ...
    },
    {
        ...
        regex: ['dodge', 'burn', 'បង្កើតពន្លឺ', 'ធ្វើឱ្យរូបលេច'],
    ...
    },
    {
        ...
        regex: ['depth of field', 'blur filter', 'bokeh', 'រូបព្រិលក្រោយ', 'ព្រិល background'], // Removed raw 'blur'
