// ==========================================
// 🎨 GRAPHIC DESIGN AI - ZERO-FLAW SUPER BRAIN
// ==========================================
...
// 🎯 Professional Quiz & Challenge Prompts
...
export const KNOWLEDGE_BASE = [
    ...
    // ------------------------------------------
    // 2. DIGITAL ASSETS & ADVANCED WORKFLOW
    // ------------------------------------------
    {
    ...
    },
    {
        ...
        chips: ["តើ Smart Object ជាអ្វី?", "របៀបបែងចែក Foreground និង Background 🏞️"],
        chips_en: ["What is a Smart Object?", "Foreground vs Background Depth 🏞️"]
    },
    {
    ...
    // ------------------------------------------
    // 4. DYNAMIC UI GENERATORS & APP LINKS
    // ------------------------------------------
    {
    ...
    // ------------------------------------------
    // 5. POSTER DESIGN, SIZES & COMPOSITION
    // ------------------------------------------
    {
    ...
    },
    {
        ...
        regex: ['framing', 'បង្កើតស៊ុម', 'ស៊ុមរូប'],
    ...
    // ------------------------------------------
    // 9. COLOR THEORY & PSYCHOLOGY
    // ------------------------------------------
    { 
        primaryKeys: ['Color Theory', 'ទ្រឹស្តីពណ៌'],
        keys: ['color theory', 'color harmony', 'របៀបរើសពណ៌', 'លាយពណ៌'],
        regex: ['color theory', 'color harmony', 'ទ្រឹស្តីពណ៌', 'របៀបរើសពណ៌', 'លាយពណ៌'],
        answer: "បាទ **ក្បួនផ្គូផ្គងពណ៌ (Color Harmonies) សំខាន់ៗមាន៖**\n\n១. **Complementary (ផ្ទុយគ្នា):** ពណ៌ដែលនៅទល់មុខគ្នាក្នុងរង្វង់ពណ៌ (ឧ. ក្រហម & ខៀវបៃតង)។ ល្អបំផុតសម្រាប់ទាក់ទាញចំណាប់អារម្មណ៍។\n២. **Analogous (ក្បែរគ្នា):** ពណ៌ ៣ ជាប់គ្នា (ឧ. លឿង ទឹកក្រូច ក្រហម)។ មើលទៅសុខដុមនិងធម្មជាតិ។\n៣. **Monochromatic:** ប្រើពណ៌តែមួយ តែលេងកម្រិតភ្លឺ/ងងឹត (Tints & Shades)។\n\n💡 **គន្លឹះ៖** កុំប្រើពណ៌ឆើតៗ លើសពី ៣ បញ្ចូលគ្នា!", 
        answer_en: "**Essential Color Harmonies:**\n\n1. **Complementary:** Colors directly opposite each other on the color wheel (e.g., Red & Cyan). Creates maximum contrast.\n2. **Analogous:** 3-4 colors next to each other (e.g., Yellow, Orange, Red). Creates a serene, unified look.\n3. **Monochromatic:** Using a single base hue but varying its lightness (Tints) and darkness (Shades).\n\n💡 **Tip:** Avoid using more than 3 highly saturated colors in one design!",
        actionButton: { label: "បង្កើតពណ៌ 🎨", label_en: "Open Color Generator 🎨", actionToTrigger: "tools", subTab: "color" },
        chips: ["អត្ថន័យនៃពណ៌ (Color Psychology)", "តើ HSL គឺជាអ្វី?"],
        chips_en: ["Color Psychology", "What is HSL?"]
    },
    { 
    ...
    { 
        ...
        actionButton: { label: "សាកល្បង HSL Tools 🎨", label_en: "Try the HSL Tools 🎨", actionToTrigger: "tools", subTab: "color" },
        chips: ["Color Theory", "អត្ថន័យនៃពណ៌ (Color Psychology)"],
        chips_en: ["Color Theory", "Color Psychology"]
    },
    ...
    { 
        primaryKeys: ['អ្វីទៅជា Vector និង Raster?', 'vector vs raster'],
        keys: ['vector', 'raster', 'វ៉ិចទ័រ', 'រ៉ាស្ទ័រ', 'pixel'],
        regex: ['vector', 'raster'],
    ...
    { 
        primaryKeys: ['តើ Blend Modes ដំណើរការយ៉ាងម៉េច?', 'how do blend modes work'],
        keys: ['blend mode', 'multiply', 'screen', 'overlay', 'របៀបលាយពណ៌'],
        regex: ['blend mode', 'multiply', 'screen', 'overlay'],
        answer: "បាទ **Blend Modes គឺជាវិធីដែល Layer ខាងលើលាយចូលជាមួយ Layer ខាងក្រោម៖**\n\n🖤 **Multiply (ក្រុមងងឹត):** លុបពណ៌សចោល ទុកតែពណ៌ងងឹត។ 💡 ល្អបំផុតសម្រាប់លុបផ្ទៃខាងក្រោយពណ៌សពីគំនូរព្រាង។\n🤍 **Screen (ក្រុមភ្លឺ):** លុបពណ៌ខ្មៅចោល ទុកតែពណ៌ភ្លឺ។ 💡 ល្អបំផុតសម្រាប់ដាក់ Effect ភ្លើង ឬផ្សែងលើរូបភាព។\n🌈 **Overlay (ក្រុម Contrast):** បន្ថែមទាំងពន្លឺនិងស្រមោល ធ្វើឱ្យរូបភាពកាន់តែដិតខ្លាំង។", 
        answer_en: "**Blend Modes dictate how a top layer interacts with the pixels underneath it:**\n\n🖤 **Multiply (Darken Group):** Makes whites totally invisible while keeping dark pixels. 💡 Example: Perfect for extracting line-art from a white background.\n🤍 **Screen (Lighten Group):** Makes blacks totally invisible while keeping light pixels. 💡 Example: Adding lens flares or fire to a photo.\n🌈 **Overlay (Contrast Group):** Boosts contrast by both multiplying darks and screening lights.",
        chips: ["Opacity និង Fill ខុសគ្នាម៉េច?", "Color Theory"],
        chips_en: ["Opacity vs Fill?", "Color Theory"]
    },
    { 
    ...
    { 
        ...
        keys: ['mask', 'masking', 'layer mask', 'clipping mask'],
    ...
    { 
        ...
        keys: ['smart object', 'smart layer', 'non-destructive'],
        regex: ['smart object', 'smart layer'],
        answer: "បាទ **Smart Object** (ឬ Embedded Document ក្នុង Affinity) គឺជាកញ្ចប់សុវត្ថិភាពសម្រាប់រូបភាព! 📦\n\nវារក្សាគុណភាពរូបភាពដើម ១០០% ទោះបីជាអ្នកបង្រួមវាឱ្យតូចប៉ុណ្ណា រួចទាញវាឱ្យធំវិញក៏ដោយ វាមិនបែកគ្រាប់ទេ។ បើអ្នកមិនដាក់វាជា Smart Object ទេ រូបភាពនឹងបាត់បង់គុណភាពរាល់ពេលអ្នកប្តូរទំហំវា។\n\n💡 **ឧទាហរណ៍៖** ពេលយក Logo មកដាក់លើ Mockup គេតែងតែប្រើ Smart Object ដើម្បីងាយស្រួលចុចចូលទៅប្តូរ Logo ដើមវិញ។", 
        answer_en: "**Smart Objects** (or Embedded Documents in Affinity) act as a protective container for image data! 📦\n\nThey preserve an image's source content fully. You can shrink a Smart Object down to a tiny size, hit enter, and then scale it back up to its original size without losing ANY quality. If it was a normal raster layer, scaling it down permanently destroys the pixels.\n\n💡 **Example:** Mockups rely on Smart Objects. You double-click the Smart Object layer, paste your design inside, hit save, and it magically updates the realistic mockup file.",
        chips: ["Affinity Symbols គឺអ្វី?", "អ្វីទៅជា Vector និង Raster?"],
        chips_en: ["What are Affinity Symbols?", "Vector vs Raster?"]
    },
    { 
    ...
    // ------------------------------------------
    // 13. LOGO DESIGN, EXPORTING & FORMATS
    // ------------------------------------------
    { 
    ...
    // ------------------------------------------
    // 14. FREELANCE BUSINESS, PRICING & ETHICS
    // ------------------------------------------
    { 
    ...
    { 
        ...
        regex: ['portfolio', 'freelance', 'រកការងារ', 'contract', 'deposit'],
    ...
    { 
        ...
        regex: ['plagiarism', 'copyright', 'កម្មសិទ្ធិបញ្ញា', 'ethics'],
    ...
    // ------------------------------------------
    // 15. FIXES & ORPHANED CHIP RECOVERY
    // ------------------------------------------
    { 
    ...
    // ------------------------------------------
    {
        ...
        answer: "បាទ សួស្តីបង! 👋 ខ្ញុំគឺជា AI ជំនាញខាង Graphic Design។ តើបងមានសំណួរអ្វីទាក់ទងនឹង Design, កម្មវិធីរចនា (ជាពិសេសម៉ាក Affinity), ឬការរៀបប្លង់ដែរ? 🎨✨",
        answer_en: "Hello there! 👋 I am your Graphic Design AI expert. We can chat about logo design, Affinity workspaces, layout structures, or even freelance business tips! What's on your mind today? 🎨✨",
        chips: ["តិចនិកប្រើ Affinity Personas 🚀", "តើ គោលការណ៍រចនា មានអ្វីខ្លះ?"],
        chips_en: ["Tips for Affinity Personas 🚀", "Core Design Principles?"]
    },
    {
    ...
    },
    {
        ...
        chips: ["របៀបប្រើ Affinity លើ iPad 📱", "Affinity Photo v3 មានអ្វីថ្មី?"],
        chips_en: ["Affinity iPad Gestures 📱", "Affinity Photo v3 Updates?"]
    },
    {
